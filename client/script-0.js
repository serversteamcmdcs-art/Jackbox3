...
var V0 = (r, t, n) => t in r ? k0(r, t, {
    enumerable: !0,
    configurable: !0,
    writable: !0,
    value: n
}) : r[t] = n;
var ze = (r, t, n) => V0(r, typeof t != "symbol" ? t + "" : t, n);
(function() {
    ...
    function n(s) {
        const f = {};
        return s.integrity && (f.integrity = s.integrity),
            s.referrerPolicy && (f.referrerPolicy = s.referrerPolicy),
            s.crossOrigin === "use-credentials" ? f.credentials = "include" : s.crossOrigin === "anonymous" ? f.credentials = "omit" : f.credentials = "same-origin",
            f
    }
...
function q0() {
    ...
    var i = 24 * 60 * 60 * 1e3,
        ...
        E = function(a, u) {
            return function() {
                return arguments[0] = "[" + u + "] " + arguments[0],
                    a.apply(P, arguments)
            }
        },
        A = function(a) {
    ...
    o.bind = function(a, u) {
            var c, h;
            if (N && a.bind === N)
                return N.apply(a, l.call(arguments, 1));
            if (!o.isFunction(a))
                throw new TypeError;
            return c = l.call(arguments, 2),
                h = function() {
            ...
            if (a != null) {
                if (k && a.forEach === k)
                    ...
                    for (var h = 0, b = a.length; h < b; h++)
                        if (h in a && u.call(c, a[h], h, a) === O)
                            return
                } else
                    for (var L in a)
                        if (x.call(a, L) && u.call(c, a[L], L, a) === O)
                            return
            }
        },
        o.extend = function(a) {
            return o.each(l.call(arguments, 1), function(u) {
                    for (var c in u)
                        u[c] !== void 0 && (a[c] = u[c])
                }),
                a
        },
        o.isArray = D || function(a) {
        ...
        o.toArray = function(a) {
            return a ? a.toArray ? a.toArray() : o.isArray(a) || o.isArguments(a) ? l.call(a) : o.values(a) : []
        },
        o.map = function(a, u, c) {
            if (ee && a.map === ee)
                return a.map(u, c);
            var h = [];
            return o.each(a, function(b) {
                    h.push(u.call(c, b))
                }),
                h
        },
        o.keys = function(a) {
            var u = [];
            return a === null || o.each(a, function(c, h) {
                    u[u.length] = h
                }),
                u
        },
        o.values = function(a) {
            var u = [];
            return a === null || o.each(a, function(c) {
                    u[u.length] = c
                }),
                u
        },
        o.include = function(a, u) {
            var c = !1;
            return a === null ? c : M && a.indexOf === M ? a.indexOf(u) != -1 : (o.each(a, function(h) {
                    if (c || (c = h === u))
                        return O
                }),
                c)
        ...
        o.encodeDates = function(a) {
            return o.each(a, function(u, c) {
                    o.isDate(u) ? a[c] = o.formatDate(u) : o.isObject(u) && (a[c] = o.encodeDates(u))
                }),
                a
        },
        ...
        o.formatDate = function(a) {
            ...
            return a.getUTCFullYear() + "-" + u(a.getUTCMonth() + 1) + "-" + u(a.getUTCDate()) + "T" + u(a.getUTCHours()) + ":" + u(a.getUTCMinutes()) + ":" + u(a.getUTCSeconds())
        },
        o.strip_empty_properties = function(a) {
            var u = {};
            return o.each(a, function(c, h) {
        ...
        o.truncate = function(a, u) {
            var c;
            return typeof a == "string" ? c = a.slice(0, u) : o.isArray(a) ? (c = [],
                    o.each(a, function(h) {
                ...
                var u = a,
                    c = function(b) {
                        ...
                        return L.lastIndex = 0,
                            L.test(b) ? '"' + b.replace(L, function(Q) {
                                var H = q[Q];
                                return typeof H == "string" ? H : "\\u" + ("0000" + Q.charCodeAt(0).toString(16)).slice(-4)
                            }) + '"' : '"' + b + '"'
                    },
                    h = function(b, L) {
                        var q = "",
                            ...
                            le = [],
                            ce = L[b];
                        switch (ce && typeof ce == "object" && typeof ce.toJSON == "function" && (ce = ce.toJSON(b)),
                            typeof ce) {
                            case "string":
                                return c(ce);
                            case "number":
                            ...
                            case "object":
                                ...
                                if (q += Q,
                                    le = [],
                                    p.apply(ce) === "[object Array]") {
                                    for (pe = ce.length,
                                        H = 0; H < pe; H += 1)
                                        le[H] = h(H, ce) || "null";
                                    return ae = le.length === 0 ? "[]" : q ? `[
` + q + le.join(`,
` + q) + `
` + J + "]" : "[" + le.join(",") + "]",
                                        q = J,
                                ...
                                for (Y in ce)
                                    x.call(ce, Y) && (ae = h(Y, ce),
                                        ae && le.push(c(Y) + (q ? ": " : ":") + ae));
                                return ae = le.length === 0 ? "{}" : q ? "{" + le.join(",") + J + "}" : "{" + le.join(",") + "}",
                                    q = J,
                                    ae
                        }
                    };
...
`,
                ...
                L = function(le) {
                    return le && le !== u && b("Expected '" + le + "' instead of '" + u + "'"),
                        u = h.charAt(a),
                        a += 1,
                        u
                },
                        ...
                        for (; L();) {
                            ...
                            if (u === "\\")
                                if (L(),
                                    u === "u") {
                                    for (ye = 0,
                                        ce = 0; ce < 4 && (le = parseInt(L(), 16),
                                            !!isFinite(le)); ce += 1)
                                        ye = ye * 16 + le;
                                    de += String.fromCharCode(ye)
                                } else if (typeof c[u] == "string")
                                de += c[u];
                            else
                                break;
                            else
                    ...
                    if (u === "{") {
                        ...
                        for (; u;) {
                            if (le = Q(),
                                H(),
                                L(":"),
                                Object.hasOwnProperty.call(ce, le) && b('Duplicate key "' + le + '"'),
                                ce[le] = ae(),
                                H(),
                                u === "}")
                                return L("}"),
...
`);
            ...
            for (c = h = 0,
                ...
                var q = a.charCodeAt(L),
                    Q = null;
                q < 128 ? h++ : q > 127 && q < 2048 ? Q = String.fromCharCode(q >> 6 | 192, q & 63 | 128) : Q = String.fromCharCode(q >> 12 | 224, q >> 6 & 63 | 128, q & 63 | 128),
                    Q !== null && (h > c && (u += a.substring(c, h)),
                        u += Q,
                        c = h = L + 1)
            }
            return h > c && (u += a.substring(c, a.length)),
                u
        },
        o.UUID = function() {
            var a = function() {
    ...
    o.isBlockedUA = function(a) {
        ...
        o.cookie = {
            get: function(a) {
                for (var u = a + "=", c = v.cookie.split(";"), h = 0; h < c.length; h++) {
                    for (var b = c[h]; b.charAt(0) == " ";)
    ...
    o.localStorage = {
            is_supported: function(a) {
                var u = W(null, a);
                return u || P.error("localStorage unsupported; falling back to cookie store"),
                    u
            },
            error: function(a) {
        ...
        o.register_event = function() {
            var a = function(h, b, L, q, Q) {
                ...
                if (h.addEventListener && !q)
                    h.addEventListener(b, L, !!Q);
                else {
                    var H = "on" + b,
                        Y = h[H];
                    h[H] = u(h, L, Y)
            ...
            function u(h, b, L) {
                var q = function(Q) {
                    if (Q = Q || c(window.event),
                        !!Q) {
                        var H = !0,
                            Y, ae;
                        return o.isFunction(L) && (Y = L(Q)),
                            ae = b.call(h, Q),
                            (Y === !1 || ae === !1) && (H = !1),
                            H
                    }
            ...
            function c(h) {
                return h && (h.preventDefault = c.preventDefault,
    ...
    o.dom_query = function() {
        ...
        function h(b) {
            if (!v.getElementsByTagName)
                return [];
            var L = b.split(" "),
                q, Q, H, Y, ae, pe, J, le, ce, de, ye = [v];
            for (pe = 0; pe < L.length; pe++) {
                if (q = L[pe].replace(/^\s+/, "").replace(/\s+$/, ""),
                    q.indexOf("#") > -1) {
                    Q = q.split("#"),
                        H = Q[0];
                    var ke = Q[1],
                        Ie = v.getElementById(ke);
                    if (!Ie || H && Ie.nodeName.toLowerCase() != H)
                        return [];
                    ye = [Ie];
                    continue
                }
                if (q.indexOf(".") > -1) {
                    ...
                    for (H || (H = "*"),
                        ...
                        ae = 0,
                        J = 0; J < ye.length; J++)
                        for (H == "*" ? ce = a(ye[J]) : ce = ye[J].getElementsByTagName(H),
                            le = 0; le < ce.length; le++)
                            Y[ae++] = ce[le];
                    for (ye = [],
                        de = 0,
                        J = 0; J < Y.length; J++)
                        Y[J].className && o.isString(Y[J].className) && c(Y[J], mt) && (ye[de++] = Y[J]);
                    continue
                }
                var or = q.match(fe);
                if (or) {
                    ...
                    switch (P0) {
                        ...
                        case "~":
                            St = function(Je) {
                                return Je.getAttribute(Tt).match(new RegExp("\\b" + Nt + "\\b"))
                            };
                            break;
                        case "|":
                            St = function(Je) {
                        ...
                        case "$":
                            St = function(Je) {
                                return Je.getAttribute(Tt).lastIndexOf(Nt) == Je.getAttribute(Tt).length - Nt.length
                            };
                            break;
                        case "*":
                            St = function(Je) {
                ...
                for (H = q,
                    ...
                    ae = 0,
                    J = 0; J < ye.length; J++)
                    for (ce = ye[J].getElementsByTagName(H),
                        le = 0; le < ce.length; le++)
                        Y[ae++] = ce[le];
                ye = Y
            }
        ...
        return function(b) {
            return o.isElement(b) ? [b] : o.isObject(b) && !o.isUndefined(b.length) ? b : h.call(this, b)
        }
    }();
    var ue = ["utm_source", "utm_medium", "utm_campaign", "utm_content", "utm_term"],
        w = ["dclid", "fbclid", "gclid", "ko_click_id", "li_fat_id", "msclkid", "ttclid", "twclid", "wbraid"];
    o.info = {
        campaignParams: function(a) {
            var u = "",
                c = {};
            return o.each(ue, function(h) {
        ...
        clickParams: function() {
            var a = "",
                u = {};
            return o.each(w, function(c) {
                    a = o.getQueryParam(v.URL, c),
                        a.length && (u[c] = a)
                }),
                u
        },
        ...
        searchEngine: function(a) {
            return a.search("https?://(.*)google.([^/?]*)") === 0 ? "google" : a.search("https?://(.*)bing.com") === 0 ? "bing" : a.search("https?://(.*)yahoo.com") === 0 ? "yahoo" : a.search("https?://(.*)duckduckgo.com") === 0 ? "duckduckgo" : null
        },
        ...
        browser: function(a, u, c) {
            return u = u || "",
                c || o.includes(a, " OPR/") ? o.includes(a, "Mini") ? "Opera Mini" : "Opera" : /(BlackBerry|PlayBook|BB10)/i.test(a) ? "BlackBerry" : o.includes(a, "IEMobile") || o.includes(a, "WPDesktop") ? "Internet Explorer Mobile" : o.includes(a, "SamsungBrowser/") ? "Samsung Internet" : o.includes(a, "Edge") || o.includes(a, "Edg/") ? "Microsoft Edge" : o.includes(a, "FBIOS") ? "Facebook Mobile" : o.includes(a, "Chrome") ? "Chrome" : o.includes(a, "CriOS") ? "Chrome iOS" : o.includes(a, "UCWEB") || o.includes(a, "UCBrowser") ? "UC Browser" : o.includes(a, "FxiOS") ? "Firefox iOS" : o.includes(u, "Apple") ? o.includes(a, "Mobile") ? "Mobile Safari" : "Safari" : o.includes(a, "Android") ? "Android Mobile" : o.includes(a, "Konqueror") ? "Konqueror" : o.includes(a, "Firefox") ? "Firefox" : o.includes(a, "MSIE") || o.includes(a, "Trident/") ? "Internet Explorer" : o.includes(a, "Gecko") ? "Mozilla" : ""
        },
        ...
        properties: function(a) {
            return typeof a != "object" && (a = {}),
                o.extend(o.strip_empty_properties({
                    $os: o.info.os(),
                    $browser: o.info.browser(X, S.vendor, d),
                    $referrer: v.referrer,
                    $referring_domain: o.info.referringDomain(v.referrer),
                    $device: o.info.device(X)
                }), {
                    $current_url: o.info.currentUrl(),
                    $browser_version: o.info.browserVersion(X, S.vendor, d),
    ...
    var F = function(a) {
            var u = Math.random().toString(36).substring(2, 10) + Math.random().toString(36).substring(2, 10);
        ...
        oe = null,
        ie = null;
    typeof JSON < "u" && (oe = JSON.stringify,
            ie = JSON.parse),
        oe = oe || o.JSONEncode,
        ie = ie || o.JSONDecode,
        o.toArray = o.toArray,
    ...
    o.inherit(V, T),
        V.prototype.create_properties = function(a, u) {
            ...
            return u.href && (c.url = u.href),
                c
        },
        V.prototype.event_handler = function(a, u, c) {
            c.new_tab = a.which === 2 || a.metaKey || a.ctrlKey || u.target === "_blank",
                c.href = u.href,
                c.new_tab || a.preventDefault()
        },
        V.prototype.after_track_handler = function(a, u) {
            u.new_tab || setTimeout(function() {
        ...
        var h = c || new Date().getTime() + "|" + Math.random(),
            ...
            le = function(Ie) {
                if (new Date().getTime() - b > Q) {
                    Ue.error("Timeout waiting for mutex on " + L + "; clearing lock. [" + h + "]"),
                        H.removeItem(pe),
                        H.removeItem(ae),
                        ye();
                    return
    ...
    Te.prototype.enqueue = function(a, u, c) {
            var h = {
                id: F(),
                flushAfter: new Date().getTime() + u * 2,
                payload: a
            };
            this.lock.withLock(o.bind(function() {
                ...
                try {
                    ...
                    q.push(h),
                        L = this.saveToStorage(q),
                        L && this.memQueue.push(h)
                } catch {
                    this.reportError("Error enqueueing item", a),
                        L = !1
                }
                c && c(L)
            }, this), o.bind(function(L) {
            ...
            if (u.length < a) {
                ...
                if (c.length) {
                    ...
                    for (var b = 0; b < c.length; b++) {
                        var L = c[b];
                        if (new Date().getTime() > L.flushAfter && !h[L.id] && (L.orphaned = !0,
                                u.push(L),
                                u.length >= a))
                            break
                    }
    ...
    Te.prototype.removeItemsByID = function(a, u) {
        ...
        var h = o.bind(function() {
            ...
            try {
                ...
                this.reportError("Error removing items", a),
                    b = !1
            }
            return b
        }, this);
        this.lock.withLock(function() {
            ...
            var q = !1;
            if (this.reportError("Error acquiring storage lock", L),
                !W(this.storage, !0) && (q = h(),
                    !q))
                try {
    ...
    Te.prototype.updatePayloads = function(a, u) {
            this.memQueue = xe(this.memQueue, a),
                this.lock.withLock(o.bind(function() {
                    ...
                    try {
                        ...
                        b = xe(b, a),
                            h = this.saveToStorage(b)
                    } catch {
                        this.reportError("Error updating items", a),
                            h = !1
                    }
                    u && u(h)
                }, this), o.bind(function(h) {
                    this.reportError("Error acquiring storage lock", h),
                        u && u(!1)
                }, this), this.pid)
        },
        Te.prototype.readFromStorage = function() {
            ...
            try {
                a = this.storage.getItem(this.storageKey),
                    a && (a = ie(a),
                        o.isArray(a) || (this.reportError("Invalid storage entry:", a),
                            a = null))
            } catch (u) {
                this.reportError("Error retrieving queue", u),
                    a = null
            }
            return a || []
        },
        Te.prototype.saveToStorage = function(a) {
            try {
                return this.storage.setItem(this.storageKey, oe(a)),
                    !0
            } catch (u) {
                return this.reportError("Error saving queue", u),
                    !1
            }
        },
    ...
    be.prototype.enqueue = function(a, u) {
        ...
        be.prototype.scheduleFlush = function(a) {
            this.flushInterval = a,
                this.stopped || (this.timeoutID = setTimeout(o.bind(this.flush, this), this.flushInterval))
        },
        be.prototype.flush = function(a) {
            try {
                ...
                var u = this.libConfig.batch_request_timeout_ms,
                    ...
                    L = [],
                    q = {};
                if (o.each(b, function(Y) {
                        var ae = Y.payload;
                        if (this.beforeSendHook && !Y.orphaned && (ae = this.beforeSendHook(ae)),
                            ae) {
                            ae.event && ae.properties && (ae.properties = o.extend({}, ae.properties, {
                                mp_sent_by_lib_version: r.LIB_VERSION
                            }));
                            var pe = !0,
                                J = Y.id;
                            J ? (this.itemIdsSentSuccessfully[J] || 0) > 5 && (this.reportError("[dupe] item ID sent too many times, not sending", {
                                        item: Y,
                                        batchSize: b.length,
                                        timesSent: this.itemIdsSentSuccessfully[J]
                                    }),
                                    pe = !1) : this.reportError("[dupe] found item with no ID", {
                                    item: Y
                                }),
                                pe && L.push(ae)
                        }
                ...
                var Q = o.bind(function(Y) {
                        ...
                        try {
                            var ae = !1;
                            if (a.unloading)
                                this.queue.updatePayloads(q);
                            else if (o.isObject(Y) && Y.error === "timeout" && new Date().getTime() - c >= u)
                                this.reportError("Network timeout; retrying"),
                                this.flush();
                            else if (o.isObject(Y) && Y.xhr_req && (Y.xhr_req.status >= 500 || Y.xhr_req.status === 429 || Y.error === "timeout")) {
                                ...
                                if (b.length > 1) {
                                    ...
                                    this.reportError("Single-event request too large; dropping", b),
                                    this.resetBatchSize(),
                                    ae = !0;
                            else
                                ae = !0;
                            ae && (this.queue.removeItemsByID(o.map(b, function(de) {
                                    return de.id
                                }), o.bind(function(de) {
                                    de ? (this.consecutiveRemovalFailures = 0,
                                ...
                                o.each(b, o.bind(function(de) {
                                    var ye = de.id;
                                    ye ? (this.itemIdsSentSuccessfully[ye] = this.itemIdsSentSuccessfully[ye] || 0,
                                        this.itemIdsSentSuccessfully[ye]++,
                                        this.itemIdsSentSuccessfully[ye] > 5 && this.reportError("[dupe] item ID sent too many times", {
                                            item: de,
                                            batchSize: b.length,
                ...
                this.reportError("Error flushing request queue", Y),
                    this.resetFlush()
            }
        },
        be.prototype.reportError = function(a, u) {
            if (Se.error.apply(Se.error, arguments),
                this.errorReporter)
                try {
                    u instanceof Error || (u = new Error(a)),
                        this.errorReporter(a, u)
                } catch (c) {
                    Se.error(c)
                }
        };
    ...
    function qe(a, u) {
        if (ar(u))
            return P.warn('This browser has "Do Not Track" enabled. This will prevent the Mixpanel SDK from sending any data. To ignore the "Do Not Track" browser setting, initialize the Mixpanel instance with the config "ignore_dnt: true"'),
                !0;
        var c = Rt(a, u) === "0";
        return c && P.warn("You are opted out of Mixpanel tracking. This will prevent the Mixpanel SDK from sending any data."),
            c
    }
    ...
    function ar(a) {
        ...
        var u = a && a.window || t,
            c = u.navigator || {},
            h = !1;
        return o.each([c.doNotTrack, c.msDoNotTrack, u.doNotTrack], function(b) {
    ...
    function At(a, u, c) {
        if (!o.isString(u) || !u.length) {
            P.error("gdpr." + (a ? "optIn" : "optOut") + " called with an invalid token");
            return
        }
        c = c || {},
            Ye(c).set(Qe(u, c), a ? 1 : 0, o.isNumber(c.cookieExpiration) ? c.cookieExpiration : null, !!c.crossSubdomainCookie, !!c.secureCookie, !!c.crossSiteCookie, c.cookieDomain),
            c.track && a && c.track(c.trackEventName || "$opt_in", c.trackProperties, {
                send_immediately: !0
            })
    }
    ...
    var g = "$set",
        ...
        U = {
            set_action: function(a, u) {
                var c = {},
                    h = {};
                return o.isObject(a) ? o.each(a, function(b, L) {
            ...
            union_action: function(a, u) {
                var c = {},
                    h = {};
                return o.isObject(a) ? o.each(a, function(b, L) {
                        this._is_reserved_property(L) || (h[L] = o.isArray(b) ? b : [b])
                    }, this) : h[a] = o.isArray(u) ? u : [u],
                    c[G] = h,
                    c
            },
    ...
    o.extend(te.prototype, U),
        ...
        te.prototype.increment = Ke(function(a, u, c) {
            var h = {},
                b = {};
            return o.isObject(a) ? (o.each(a, function(L, q) {
                        if (!this._is_reserved_property(q))
                            if (isNaN(parseFloat(L))) {
                                P.error("Invalid increment value passed to mixpanel.people.increment - must be a number");
                                return
                            } else
                                b[q] = L
                    }, this),
                    c = u) : (o.isUndefined(u) && (u = 1),
                    b[a] = u),
                h[_] = b,
                this._send_request(h, c)
        }),
        ...
        te.prototype.track_charge = Ke(function(a, u, c) {
            if (!o.isNumber(a) && (a = parseFloat(a),
                    isNaN(a))) {
        ...
        te.prototype._send_request = function(a, u) {
            ...
            return this._identify_called() ? this._mixpanel._track_or_batch({
                ...
                o.isUndefined(u) || (this._get_config("verbose") ? u({
                    status: -1,
                    error: null
                }) : u(-1)),
                o.truncate(L, 255))
        ...
        te.prototype._enqueue = function(a) {
            g in a ? this._mixpanel.persistence._add_to_people_queue(g, a) : y in a ? this._mixpanel.persistence._add_to_people_queue(y, a) : K in a ? this._mixpanel.persistence._add_to_people_queue(K, a) : _ in a ? this._mixpanel.persistence._add_to_people_queue(_, a) : C in a ? this._mixpanel.persistence._add_to_people_queue(C, a) : z in a ? this._mixpanel.persistence._add_to_people_queue(z, a) : G in a ? this._mixpanel.persistence._add_to_people_queue(G, a) : P.error("Invalid call to _enqueue():", a)
        },
        te.prototype._flush_one_queue = function(a, u, c, h) {
            var b = this,
                L = o.extend({}, this._mixpanel.persistence.load_queue(a)),
                q = L;
            !o.isUndefined(L) && o.isObject(L) && !o.isEmptyObject(L) && (b._mixpanel.persistence._pop_from_people_queue(a, L),
        ...
        te.prototype._is_reserved_property = function(a) {
            return a === "$distinct_id" || a === "$token" || a === "$device_id" || a === "$user_id" || a === "$had_persisted_distinct_id"
        },
    ...
    var re = "__mps",
        ...
        Xe = "__alias",
        yt = "__timers",
        Sr = [re, _e, et, st, Ge, tt, Bt, ot, Xe, yt],
        ge = function(a) {
            this.props = {},
                this.campaign_params_saved = !1,
                a.persistence_name ? this.name = "mp_" + a.persistence_name : this.name = "mp_" + a.token + "_mixpanel";
            var u = a.persistence;
            u !== "cookie" && u !== "localStorage" && (P.critical("Unknown persistence type " + u + "; falling back to cookie"),
                    u = a.persistence = "cookie"),
                u === "localStorage" && o.localStorage.is_supported() ? this.storage = o.localStorage : this.storage = o.cookie,
                this.load(),
    ...
    ge.prototype.properties = function() {
        ...
        ge.prototype.upgrade = function() {
            var a, u;
            this.storage === o.localStorage ? (a = o.cookie.parse(this.name),
                o.cookie.remove(this.name),
                o.cookie.remove(this.name, !0),
                a && this.register_once(a)) : this.storage === o.cookie && (u = o.localStorage.parse(this.name),
        ...
        ge.prototype.register_once = function(a, u, c) {
            return o.isObject(a) ? (typeof u > "u" && (u = "None"),
                this.expire_days = typeof c > "u" ? this.default_expiry : c,
                this.load(),
                o.each(a, function(h, b) {
                    (!this.props.hasOwnProperty(b) || this.props[b] === u) && (this.props[b] = h)
                }, this),
                this.save(),
                !0) : !1
        },
        ge.prototype.register = function(a, u) {
            return o.isObject(a) ? (this.expire_days = typeof u > "u" ? this.default_expiry : u,
                this.load(),
        ...
        ge.prototype.set_cookie_domain = function(a) {
            a !== this.cookie_domain && (this.remove(),
                this.cookie_domain = a,
                this.save())
        },
        ge.prototype.set_cross_site = function(a) {
            a !== this.cross_site && (this.cross_site = a,
                this.remove(),
                this.save())
        },
        ...
        ge.prototype._add_to_people_queue = function(a, u) {
            ...
            c === re ? (o.extend(b, h),
                    ...
                    this._pop_from_people_queue(K, h)) : c === _e ? (o.each(h, function(pe, J) {
                        J in L || (L[J] = pe)
                    }),
                    this._pop_from_people_queue(K, h)) : c === et ? o.each(h, function(pe) {
                    o.each([b, L, Q, H], function(J) {
                        ...
                        q[pe] = !0
                }) : c === st ? (o.each(h, function(pe, J) {
                        J in b ? b[J] += pe : (J in Q || (Q[J] = 0),
                            Q[J] += pe)
                    }, this),
                    this._pop_from_people_queue(K, h)) : c === Bt ? (o.each(h, function(pe, J) {
                        o.isArray(pe) && (J in H || (H[J] = []),
                            H[J] = H[J].concat(pe))
                    }),
                    this._pop_from_people_queue(K, h)) : c === tt ? (Y.push(h),
                    this._pop_from_people_queue(C, h)) : c === Ge && (ae.push(h),
        ...
        ge.prototype._pop_from_people_queue = function(a, u) {
            ...
            o.isUndefined(c) || o.each(u, function(h, b) {
                a === C || a === z ? o.each(c, function(L) {
                    L[b] === h && delete L[b]
                }) : delete c[b]
            }, this)
        },
        ...
        ge.prototype._get_or_create_queue = function(a, u) {
            var c = this._get_queue_key(a);
            return u = o.isUndefined(u) ? {} : u,
                this.props[c] || (this.props[c] = u)
        },
        ...
        ge.prototype.remove_event_timer = function(a) {
            var u = this.load_prop(yt) || {},
                c = u[a];
            return o.isUndefined(c) || (delete this.props[yt][a],
                    this.save()),
                c
        };
    var lt, Pe, Ut = 0,
        ...
        vr = !ct && X.indexOf("MSIE") === -1 && X.indexOf("Mozilla") === -1,
        bt = null;
    S.sendBeacon && (bt = function() {
    ...
    var pt = {
        ...
        an = function(a, u, c) {
            ...
            return r.DEBUG = r.DEBUG || h.get_config("debug"),
                !o.isUndefined(b) && o.isArray(b) && (h._execute_array.call(h.people, b.people),
                    h._execute_array(b)),
                h
        };
    j.prototype.init = function(a, u, c) {
            if (o.isUndefined(c)) {
        ...
        j.prototype._init = function(a, u, c) {
            u = u || {},
                this.__loaded = !0,
                this.config = {};
            var h = {};
            ...
            if (this.set_config(o.extend({}, wt, h, u, {
                    name: c,
                    token: a,
                ...
                if (!o.localStorage.is_supported(!0) || !ct)
                    ...
                    P.log("Turning off Mixpanel request-queueing; needs XHR and localStorage support"),
        ...
        j.prototype.start_session_recording = me(function() {
            if (!t.MutationObserver) {
                P.critical("Browser does not support MutationObserver; skipping session recording");
                return
            }
        ...
        j.prototype.stop_session_recording = function() {
            this._recorder ? this._recorder.stopRecording() : P.critical("Session recorder module not loaded")
        },
        j.prototype.get_session_recording_properties = function() {
            var a = {};
            if (this._recorder) {
        ...
        j.prototype._set_default_superprops = function() {
            this.persistence.update_search_keyword(v.referrer),
                this.get_config("store_google") && !this.get_config("stop_utm_persistence") && this.register(o.info.campaignParams()),
                this.get_config("save_referrer") && this.persistence.update_referrer_info(v.referrer)
        },
        j.prototype._dom_loaded = function() {
            o.each(this.__dom_loaded_queue, function(a) {
                    this._track_dom.apply(this, a)
                }, this),
                this.has_opted_out_tracking() || o.each(this.__request_queue, function(a) {
                    this._send_request.apply(this, a)
                }, this),
                delete this.__dom_loaded_queue,
                delete this.__request_queue
        },
        j.prototype._track_dom = function(a, u) {
            if (this.get_config("img"))
                return this.report_error("You can't use DOM tracking functions with img = true."),
                    !1;
            if (!Lr)
                return this.__dom_loaded_queue.push([a, u]),
                    !1;
            var c = new a().init(this);
            return c.track.apply(c, u)
        },
        j.prototype._init_url_change_tracking = function(a) {
            var u = "",
                c = this.track_pageview();
            if (c && (u = o.info.currentUrl()),
                o.include(["full-url", "url-with-path-and-query-string", "url-with-path"], a)) {
                ...
                typeof h == "function" && (t.history.pushState = function(L, q, Q) {
                    h.call(t.history, L, q, Q),
                        t.dispatchEvent(new Event("mp_locationchange"))
                });
                var b = t.history.replaceState;
                typeof b == "function" && (t.history.replaceState = function(L, q, Q) {
                    ...
                    t.addEventListener("mp_locationchange", (function() {
                        var L = o.info.currentUrl(),
                            q = !1;
                        if (a === "full-url" ? q = L !== u : a === "url-with-path-and-query-string" ? q = L.split("#")[0] !== u.split("#")[0] : a === "url-with-path" && (q = L.split("#")[0].split("?")[0] !== u.split("#")[0].split("?")[0]),
                            q) {
        ...
        j.prototype._prepare_callback = function(a, u) {
            if (o.isUndefined(a))
                return null;
            if (ct) {
                var c = function(q) {
        ...
        j.prototype._send_request = function(a, u, c, h) {
            var b = !0;
            if (vr)
            ...
            var L = {
                ...
                q = null;
            !h && (o.isFunction(c) || typeof c == "string") && (h = c,
                    c = null),
                c = o.extend(L, c || {}),
                ct || (c.method = "GET");
            var Q = c.method === "POST",
            ...
            u.verbose && (Y = !0),
                ...
                ct || (h ? u.callback = h : (Y || this.get_config("test")) && (u.callback = "(function(){})")),
                u.ip = this.get_config("ip") ? 1 : 0,
                u._ = new Date().getTime().toString(),
                Q && (q = "data=" + encodeURIComponent(u.data),
                    delete u.data),
            ...
            if ("img" in u) {
                ...
                try {
                    ...
                    if (Q && (le["Content-Type"] = "application/x-www-form-urlencoded"),
                                    ...
                                    if (h)
                                        if (Y) {
                                            ...
                                            try {
                                                ...
                                                if (ae.report_error(mt),
                                                    c.ignore_json_errors)
                                                    ke = J.responseText;
                                                else
                                                    return
                                            }
                                            ...
                                            h(Number(J.responseText))
                                } else {
                                    var Ie;
                                    J.timeout && !J.status && new Date().getTime() - ce >= J.timeout ? Ie = "timeout" : Ie = "Bad HTTP status: " + J.status + " " + J.statusText,
                                        ae.report_error(Ie),
                                        h && h(Y ? {
                                            status: 0,
                                            error: Ie,
        ...
        j.prototype._execute_array = function(a) {
            var u, c = [],
                h = [],
                b = [];
            o.each(a, function(q) {
                q && (u = q[0],
                    o.isArray(u) ? b.push(q) : typeof q == "function" ? q.call(this) : o.isArray(q) && u === "alias" ? c.push(q) : o.isArray(q) && u.indexOf("track") !== -1 && typeof this[u] == "function" ? b.push(q) : h.push(q))
            }, this);
            var L = function(q, Q) {
                o.each(q, function(H) {
                    if (o.isArray(H[0])) {
        ...
        j.prototype.are_batchers_initialized = function() {
            return !!this.request_batchers.events
        },
        j.prototype.get_batcher_configs = function() {
        ...
        j.prototype.init_batchers = function() {
            if (!this.are_batchers_initialized()) {
                var a = o.bind(function(c) {
                        return new be(c.queue_key, {
                            libConfig: this.config,
                            sendRequestFunc: o.bind(function(h, b, L) {
                                this._send_request(this.get_config("api_host") + c.endpoint, this._encode_data_for_request(h), b, this._prepare_callback(L, h))
                            }, this),
        ...
        j.prototype.start_batch_senders = function() {
        ...
        j.prototype.stop_batch_senders = function() {
            this._batch_requests = !1,
                o.each(this.request_batchers, function(a) {
                    a.stop(),
                        a.clear()
        ...
        j.prototype.disable = function(a) {
            typeof a > "u" ? this._flags.disable_all_events = !0 : this.__disabled_events = this.__disabled_events.concat(a)
        },
        j.prototype._encode_data_for_request = function(a) {
            var u = o.JSONEncode(a);
            return this.get_config("api_payload_format") === Xt && (u = o.base64Encode(u)), {
                data: u
            }
        },
        j.prototype._track_or_batch = function(a, u) {
            ...
            var Q = !0,
                H = o.bind(function() {
                    return q.skip_hooks || (c = this._run_hook("before_send_" + a.type, c)),
                        c ? (P.log("MIXPANEL REQUEST:"),
                            P.log(c),
                            this._send_request(h, this._encode_data_for_request(c), q, this._prepare_callback(u, c))) : null
                }, this);
            return this._batch_requests && !L ? b.enqueue(c, function(Y) {
                    Y ? u(1, c) : H()
                }) : Q = H(),
                Q && c
        },
        j.prototype.track = me(function(a, u, c, h) {
            !h && typeof c == "function" && (h = c,
                    c = null),
                c = c || {};
            var b = c.transport;
            b && (c.transport = b);
            var L = c.send_immediately;
            if (typeof h != "function" && (h = gt),
                o.isUndefined(a)) {
            ...
            this._set_default_superprops();
            var H = this.get_config("track_marketing") ? o.info.marketingParams() : {};
            u = o.extend({}, o.info.properties({
                mp_loader: this.get_config("mp_loader")
            }), H, this.persistence.properties(), this.unpersisted_superprops, this.get_session_recording_properties(), u);
            var Y = this.get_config("property_blacklist");
            o.isArray(Y) ? o.each(Y, function(J) {
                delete u[J]
            }) : this.report_error("Invalid value for property_blacklist config: " + Y);
            var ae = {
                    event: a,
                    properties: u
                },
        ...
        j.prototype.set_group = me(function(a, u, c) {
            o.isArray(u) || (u = [u]);
            var h = {};
            return h[a] = u,
                this.register(h),
                this.people.set(a, u, c)
        }),
        j.prototype.add_group = me(function(a, u, c) {
            var h = this.get_property(a),
                b = {};
            return h === void 0 ? (b[a] = [u],
                    this.register(b)) : h.indexOf(u) === -1 && (h.push(u),
                    b[a] = h,
                    this.register(b)),
                this.people.union(a, u, c)
        }),
        j.prototype.remove_group = me(function(a, u, c) {
            var h = this.get_property(a);
            if (h !== void 0) {
                var b = h.indexOf(u);
                b > -1 && (h.splice(b, 1),
        ...
        j.prototype.track_with_groups = me(function(a, u, c, h) {
            var b = o.extend({}, u || {});
            return o.each(c, function(L, q) {
                    L != null && (b[q] = L)
                }),
                this.track(a, b, h)
        }),
        j.prototype._create_map_key = function(a, u) {
            return a + "_" + JSON.stringify(u)
        },
        j.prototype._remove_group_from_cache = function(a, u) {
            delete this._cached_groups[this._create_map_key(a, u)]
        },
        j.prototype.get_group = function(a, u) {
            var c = this._create_map_key(a, u),
                h = this._cached_groups[c];
            return (h === void 0 || h._group_key !== a || h._group_id !== u) && (h = new ne,
                    h._init(this, a, u),
                    this._cached_groups[c] = h),
                h
        },
        j.prototype.track_pageview = me(function(a, u) {
            typeof a != "object" && (a = {}),
                u = u || {};
            var c = u.event_name || "$mp_web_page_view",
                h = o.extend(o.info.mpPageViewProperties(), o.info.campaignParams(), o.info.clickParams()),
                b = o.extend({}, h, a);
            return this.track(c, b)
        }),
        j.prototype.track_links = function() {
            return this._track_dom.call(this, V, arguments)
        },
        j.prototype.track_forms = function() {
            return this._track_dom.call(this, Ee, arguments)
        },
        j.prototype.time_event = function(a) {
            if (o.isUndefined(a)) {
                this.report_error("No event name provided to mixpanel.time_event");
                return
            }
            this._event_is_disabled(a) || this.persistence.set_event_timer(a, new Date().getTime())
        };
    var K0 = {
            persistent: !0
        },
        fn = function(a) {
            var u;
            return o.isObject(a) ? u = a : o.isUndefined(a) ? u = {} : u = {
                    days: a
                },
                o.extend({}, K0, u)
        };
    j.prototype.register = function(a, u) {
            var c = fn(u);
            c.persistent ? this.persistence.register(a, c.days) : o.extend(this.unpersisted_superprops, a)
        },
        j.prototype.register_once = function(a, u, c) {
            var h = fn(c);
            h.persistent ? this.persistence.register_once(a, u, h.days) : (typeof u > "u" && (u = "None"),
                o.each(a, function(b, L) {
                    (!this.unpersisted_superprops.hasOwnProperty(L) || this.unpersisted_superprops[L] === u) && (this.unpersisted_superprops[L] = b)
                }, this))
        },
        j.prototype.unregister = function(a, u) {
            u = fn(u),
                u.persistent ? this.persistence.unregister(a) : delete this.unpersisted_superprops[a]
        },
        j.prototype._register_single = function(a, u) {
            var c = {};
            c[a] = u,
                this.register(c)
        },
        j.prototype.identify = function(a, u, c, h, b, L, q, Q) {
            ...
            a !== H && a !== this.get_property(Xe) && (this.unregister(Xe),
                    this.register({
                        distinct_id: a
                    })),
                this._flags.identify_called = !0,
                this.people._flush(u, c, h, b, L, q, Q),
                a !== H && this.track("$identify", {
                    distinct_id: a,
                    $anon_distinct_id: H
                }, {
                    skip_hooks: !0
        ...
        j.prototype.get_distinct_id = function() {
            return this.get_property("distinct_id")
        },
        j.prototype.alias = function(a, u) {
            if (a === this.get_property(ot))
                return this.report_error("Attempting to create alias for existing People user - aborting."),
                    -2;
            var c = this;
            return o.isUndefined(u) && (u = this.get_distinct_id()),
                a !== u ? (this._register_single(Xe, a),
        ...
        j.prototype.name_tag = function(a) {
            this._register_single("mp_name_tag", a)
        },
        j.prototype.set_config = function(a) {
            if (o.isObject(a)) {
                o.extend(this.config, a);
                var u = a.batch_size;
                u && o.each(this.request_batchers, function(c) {
                        c.resetBatchSize()
                    }),
        ...
        j.prototype.get_config = function(a) {
            return this.config[a]
        },
        j.prototype._run_hook = function(a) {
            var u = (this.config.hooks[a] || ur).apply(this, l.call(arguments, 1));
            return typeof u > "u" && (this.report_error(a + " hook did not return a value"),
                    u = null),
                u
        },
        j.prototype.get_property = function(a) {
        ...
        j.prototype._event_is_disabled = function(a) {
            return o.isBlockedUA(X) || this._flags.disable_all_events || o.include(this.__disabled_events, a)
        },
        j.prototype._gdpr_init = function() {
            var a = this.get_config("opt_out_tracking_persistence_type") === "localStorage";
            a && o.localStorage.is_supported() && (!this.has_opted_in_tracking() && this.has_opted_in_tracking({
                ...
                this.has_opted_out_tracking() ? this._gdpr_update_persistence({
                    clear_persistence: !0
                }) : !this.has_opted_in_tracking() && (this.get_config("opt_out_tracking_by_default") || o.cookie.get("mp_optout")) && (o.cookie.remove("mp_optout"),
                    this.opt_out_tracking({
                        clear_persistence: this.get_config("opt_out_persistence_by_default")
                    }))
        },
        j.prototype._gdpr_update_persistence = function(a) {
            var u;
            if (a && a.clear_persistence)
                u = !0;
            else if (a && a.enable_persistence)
                u = !1;
            else
                return;
            !this.get_config("disable_persistence") && this.persistence.disabled !== u && this.persistence.set_disabled(u),
                u ? this.stop_batch_senders() : this._batchers_were_started && this.start_batch_senders()
        },
        j.prototype._gdpr_call_func = function(a, u) {
            return u = o.extend({
        ...
        j.prototype.opt_in_tracking = function(a) {
            a = o.extend({
        ...
        j.prototype.opt_out_tracking = function(a) {
            a = o.extend({
                    clear_persistence: !0,
                    delete_user: !0
                }, a),
                a.delete_user && this.people && this.people._identify_called() && (this.people.delete_user(),
                    this.people.clear_charges()),
                this._gdpr_call_func(Oe, a),
                this._gdpr_update_persistence(a)
        },
        j.prototype.has_opted_in_tracking = function(a) {
            return this._gdpr_call_func(Ve, a)
        },
        j.prototype.has_opted_out_tracking = function(a) {
            return this._gdpr_call_func(qe, a)
        },
        j.prototype.clear_opt_in_out_tracking = function(a) {
            a = o.extend({
                    enable_persistence: !0
                }, a),
        ...
        j.prototype.report_error = function(a, u) {
        ...
        j.prototype.time_event = j.prototype.time_event,
        j.prototype.track = j.prototype.track,
        j.prototype.track_links = j.prototype.track_links,
        j.prototype.track_forms = j.prototype.track_forms,
        j.prototype.track_pageview = j.prototype.track_pageview,
        j.prototype.register = j.prototype.register,
        j.prototype.register_once = j.prototype.register_once,
        j.prototype.unregister = j.prototype.unregister,
        j.prototype.identify = j.prototype.identify,
        j.prototype.alias = j.prototype.alias,
        j.prototype.name_tag = j.prototype.name_tag,
        j.prototype.set_config = j.prototype.set_config,
        j.prototype.get_config = j.prototype.get_config,
        j.prototype.get_property = j.prototype.get_property,
        j.prototype.get_distinct_id = j.prototype.get_distinct_id,
        j.prototype.toString = j.prototype.toString,
        j.prototype.opt_out_tracking = j.prototype.opt_out_tracking,
        j.prototype.opt_in_tracking = j.prototype.opt_in_tracking,
        j.prototype.has_opted_out_tracking = j.prototype.has_opted_out_tracking,
        j.prototype.has_opted_in_tracking = j.prototype.has_opted_in_tracking,
        j.prototype.clear_opt_in_out_tracking = j.prototype.clear_opt_in_out_tracking,
        j.prototype.get_group = j.prototype.get_group,
        j.prototype.set_group = j.prototype.set_group,
        j.prototype.add_group = j.prototype.add_group,
        j.prototype.remove_group = j.prototype.remove_group,
        j.prototype.track_with_groups = j.prototype.track_with_groups,
        j.prototype.start_batch_senders = j.prototype.start_batch_senders,
        j.prototype.stop_batch_senders = j.prototype.stop_batch_senders,
        j.prototype.start_session_recording = j.prototype.start_session_recording,
        j.prototype.stop_session_recording = j.prototype.stop_session_recording,
        j.prototype.get_session_recording_properties = j.prototype.get_session_recording_properties,
        j.prototype.DEFAULT_API_ROUTES = pt,
    ...
    var $t = {},
        ...
        N0 = function() {
            Pe.init = function(a, u, c) {
                if (c)
                    return Pe[c] || (Pe[c] = $t[c] = an(a, u, c),
                            Pe[c]._loaded()),
                        Pe[c];
                var h = Pe;
                $t[We] ? h = $t[We] : a && (h = an(a, u, We),
                        h._loaded(),
                        $t[We] = h),
                    Pe = h,
                    lt === fr && (t[We] = Pe),
        ...
        I0 = function() {
            ...
            if (v.addEventListener)
                v.readyState === "complete" ? a() : v.addEventListener("DOMContentLoaded", a, !1);
...
class j0 {
    ...
    setup() {
        gtag("config", "G-V1QJVQMYF1", {
            ...
            cf.init("2e284873b7269f13b850ac994abfd848", {
                debug: "false"
            }),
...
const X0 = [{
    ...
    name: "А голову ты не забыл 2015",
    tag: "ydkj2015",
    wrapper: "marionette",
    isPublic: !0,
    ...
    name: "А голову ты не забыл? Full Stream",
    tag: "ydkj2018",
    wrapper: "marionette",
    isPublic: !0,
...
const yc = [...X0, ...$0],
    pf = r => {
        var n;
        return (((n = window == null ? void 0 : window.tv) == null ? void 0 : n.games) || yc).find(i => i.tag === r || i.galleryId === r || i.categoryId === r)
    };
var on, Ef;
...
function gc() {
    if (vf)
        return mn;
    vf = 1;
    var r = typeof je == "object" && je && je.Object === Object && je;
    return mn = r,
        mn
}
var Tn, Lf;
...
function Wr() {
    ...
    function e(l) {
        return l == null ? l === void 0 ? s : i : f && f in Object(l) ? t(l) : n(l)
    }
    return Ln = e,
        Ln
}
...
function ap() {
    ...
    var r = Na(),
        ...
        p = e.toString,
        x = l.hasOwnProperty,
        R = RegExp("^" + p.call(x).replace(s, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
...
function Sc() {
    ...
    function n(i, s, f) {
        (f !== void 0 && !t(i[s], f) || f === void 0 && !(s in i)) && r(i, s, f)
    }
    return ti = n,
        ti
}
...
function Pp() {
    ...
    $[M] = $[ee] = $[D] = $[O] = $[o] = $[P] = $[E] = $[A] = $[B] = !0,
        $[i] = $[s] = $[N] = $[f] = $[k] = $[e] = $[l] = $[p] = $[x] = $[R] = $[S] = $[v] = $[d] = $[I] = $[X] = !1;
...
function wc() {
    ...
    function n(i, s) {
        var f = typeof i;
        return s = s ?? r,
            !!s && (f == "number" || f != "symbol" && t.test(i)) && i > -1 && i % 1 == 0 && i < s
    }
    return Bi = n,
        Bi
}
...
function jp() {
    ...
    function p(x, R) {
        var S = n(x),
            ...
            I = !S && !v && !d && f(x),
            X = S || v || d || I,
            N = X ? r(x.length, String) : [],
            k = N.length;
        for (var M in x)
            (R || l.call(x, M)) && !(X && (M == "length" || d && (M == "offset" || M == "parent") || I && (M == "buffer" || M == "byteLength" || M == "byteOffset") || s(M, k))) && N.push(M);
        return N
    }
    return Ui = p,
        Ui
...
function $p() {
    ...
    function f(e) {
        ...
        var l = t(e),
            p = [];
        for (var x in e)
            x == "constructor" && (l || !s.call(e, x)) || p.push(x);
        return p
    }
    return wi = f,
        wi
    ...
    function X(N, k, M, ee, D, O, o) {
        ...
        if ($) {
            var W = e(E),
                ...
                ue = !W && !fe && v(E);
            B = E,
                W || fe || ue ? e(P) ? B = P : l(P) ? B = i(P) : fe ? ($ = !1,
                    B = t(E, !0)) : ue ? ($ = !1,
                    B = n(E, !0)) : B = [] : S(E) || f(E) ? (B = P,
                    f(P) ? B = I(P) : (!R(P) || x(P)) && (B = s(E))) : $ = !1
        }
        $ && (o.set(E, B),
                D(B, E, ee, O, o),
                o.delete(E)),
...
function Wp() {
    ...
    function l(p, x, R, S, v) {
        p !== x && n(x, function(d, I) {
            if (v || (v = new r),
                s(d))
                i(p, x, I, R, l, S, v);
            else {
                var X = S ? S(e(p, I), d, I + "", p, x, v) : void 0;
                X === void 0 && (X = d),
                    t(p, I, X)
            }
        }, f)
...
function Jp() {
    ...
    function n(i, s, f) {
        return s = t(s === void 0 ? i.length - 1 : s, 0),
            function() {
                for (var e = arguments, l = -1, p = t(e.length - s, 0), x = Array(p); ++l < p;)
                    x[l] = e[s + l];
                l = -1;
                for (var R = Array(s + 1); ++l < s;)
                    R[l] = e[l];
                return R[s] = f(x),
                    r(i, this, R)
            }
...
function rE() {
    ...
    function s(f, e, l) {
        if (!i(l))
            return !1;
        var p = typeof e;
        return (p == "number" ? t(l) && n(e, l.length) : p == "string" && e in l) ? r(l[e], f) : !1
    }
    return $i = s,
        $i
}
    ...
    function n(i) {
        return r(function(s, f) {
            var e = -1,
                ...
                p = l > 1 ? f[l - 1] : void 0,
                x = l > 2 ? f[2] : void 0;
            for (p = i.length > 3 && typeof p == "function" ? (l--,
                    p) : void 0,
                x && t(f[0], f[1], x) && (p = l < 3 ? void 0 : p,
                    l = 1),
                s = Object(s); ++e < l;) {
                var R = f[e];
                R && i(s, R, e, p)
...
const zt = class zt {
    static get serverUrl() {
        ...
        if (!t || t === "live") return window.__JACKBOX_SERVER__ || window.location.hostname;
        if (t === "local") return "https://localhost";
        if (t.includes("localhost") || t.includes(".")) return t;
        return `${t}.jackboxgames.com`;
    }
    static isDevelopment() {
        return window.location.hostname === "dev.jackbox.tv" || window.location.hostname === "localhost"
    }
    static isProduction() {
        return !["dev.jackbox.tv", "localhost"].includes(window.location.hostname) && window.location.hostname !== ""
    }
    ...
    static htmlTagsToBBCode(t, n) {
        ...
        return n.reduce((i, s) => (i.replaceAll(`<${s[0]}>`, `[${s[1]}]`),
    ...
    static adjustColor(t, n) {
        ...
        let x = (Math.min(Math.max(0, (f & 255) * n), 255) | l << 8 | e << 16).toString(16);
    ...
    static cyrb128(t) {
        ...
        return n = Math.imul(s ^ n >>> 18, 597399067),
...
class Vr {
    ...
    static setup(t, n) {
        delete window.tv.storage,
            ...
            n && (window.tv.storage.code = n.toLowerCase(),
    ...
    static getScopedKey(t, n) {
        ...
        return f && window.localStorage.getItem(f) !== null ? f : s && window.localStorage.getItem(s) !== null ? s : i
    }
...
function sE() {
    return to || (to = 1,
            function(r, t) {
                var n = typeof globalThis < "u" && globalThis || typeof self < "u" && self || typeof je < "u" && je,
                    i = function() {
                        function f() {
                            this.fetch = !1,
                                this.DOMException = n.DOMException
                        }
                        return f.prototype = n,
                            new f
                    }();
                (function(f) {
                    (function(e) {
                        var l = typeof f < "u" && f || typeof self < "u" && self || typeof je < "u" && je || {},
                            p = {
                        ...
                        if (p.arrayBuffer)
                            var R = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"],
                                S = ArrayBuffer.isView || function(w) {
                                    return w && R.indexOf(Object.prototype.toString.call(w)) > -1
                                };
                        ...
                        function d(w) {
                            return typeof w != "string" && (w = String(w)),
                                w
                        }
                        ...
                        function I(w) {
                            ...
                            return p.iterable && (F[Symbol.iterator] = function() {
                                    return F
                                }),
                                F
                        }
                        ...
                        function X(w) {
                            this.map = {},
                                w instanceof X ? w.forEach(function(F, se) {
                                    this.append(se, F)
                                }, this) : Array.isArray(w) ? w.forEach(function(F) {
                                    if (F.length != 2)
                                        throw new TypeError("Headers constructor: expected name/value pair to be length 2, found" + F.length);
                                    this.append(F[0], F[1])
                                }, this) : w && Object.getOwnPropertyNames(w).forEach(function(F) {
                                    this.append(F, w[F])
                                }, this)
                        }
                        X.prototype.append = function(w, F) {
                                w = v(w),
                                    F = d(F);
                                var se = this.map[w];
                            ...
                            X.prototype.forEach = function(w, F) {
                                for (var se in this.map)
                                    this.map.hasOwnProperty(se) && w.call(F, this.map[se], se, this)
                            },
                            X.prototype.keys = function() {
                                var w = [];
                                return this.forEach(function(F, se) {
                                        w.push(se)
                                    }),
                                    I(w)
                            },
                            ...
                            p.iterable && (X.prototype[Symbol.iterator] = X.prototype.entries);
                        ...
                        function ee(w) {
                            var F = new FileReader,
                                ...
                                he = Z ? Z[1] : "utf-8";
                            return F.readAsText(w, he),
                                se
                        }

                        function D(w) {
                            for (var F = new Uint8Array(w), se = new Array(F.length), Z = 0; Z < F.length; Z++)
                            ...
                            return this.bodyUsed = !1,
                                this._initBody = function(w) {
                                    this.bodyUsed = this.bodyUsed,
                                        this._bodyInit = w,
                                        w ? typeof w == "string" ? this._bodyText = w : p.blob && Blob.prototype.isPrototypeOf(w) ? this._bodyBlob = w : p.formData && FormData.prototype.isPrototypeOf(w) ? this._bodyFormData = w : p.searchParams && URLSearchParams.prototype.isPrototypeOf(w) ? this._bodyText = w.toString() : p.arrayBuffer && p.blob && x(w) ? (this._bodyArrayBuffer = O(w.buffer),
                                            this._bodyInit = new Blob([this._bodyArrayBuffer])) : p.arrayBuffer && (ArrayBuffer.prototype.isPrototypeOf(w) || S(w)) ? this._bodyArrayBuffer = O(w) : this._bodyText = w = Object.prototype.toString.call(w) : (this._noBody = !0,
                                            this._bodyText = ""),
                                        this.headers.get("content-type") || (typeof w == "string" ? this.headers.set("content-type", "text/plain;charset=UTF-8") : this._bodyBlob && this._bodyBlob.type ? this.headers.set("content-type", this._bodyBlob.type) : p.searchParams && URLSearchParams.prototype.isPrototypeOf(w) && this.headers.set("content-type", "application/x-www-form-urlencoded;charset=UTF-8"))
                                },
                        ...
                        function A(w, F) {
                            ...
                            if (this._initBody(se),
                                ...
                                if (Z.test(this.url))
                                    ...
                                    var he = /\?/;
                                    this.url += (he.test(this.url) ? "&" : "?") + "_=" + new Date().getTime()
                                }
                            }
                        }
                        ...
                        function B(w) {
                            var F = new FormData;
                            return w.trim().split("&").forEach(function(se) {
                                    if (se) {
                                        var Z = se.split("="),
                        ...
                        function $(w) {
                            var F = new X,
                                se = w.replace(/\r?\n[\t ]+/g, " ");
                            return se.split("\r").map(function(Z) {
                                    return Z.indexOf(`
                        ...
                        function ue(w, F) {
                            return new Promise(function(se, Z) {
                                ...
                                oe.onload = function() {
                                        ...
                                        he.url.indexOf("file://") === 0 && (oe.status < 200 || oe.status > 599) ? Ee.status = 200 : Ee.status = oe.status,
                                            Ee.url = "responseURL" in oe ? oe.responseURL : Ee.headers.get("X-Request-URL");
                                ...
                                if (oe.open(he.method, T(he.url), !0),
                                    he.credentials === "include" ? oe.withCredentials = !0 : he.credentials === "omit" && (oe.withCredentials = !1),
                                    "responseType" in oe && (p.blob ? oe.responseType = "blob" : p.arrayBuffer && (oe.responseType = "arraybuffer")),
                                    F && typeof F.headers == "object" && !(F.headers instanceof X || l.Headers && F.headers instanceof l.Headers)) {
                                    var V = [];
                                    Object.getOwnPropertyNames(F.headers).forEach(function(Ee) {
                                            V.push(v(Ee)),
                                                oe.setRequestHeader(Ee, d(F.headers[Ee]))
                                        }),
                                ...
                                he.signal && (he.signal.addEventListener("abort", ie),
                                        oe.onreadystatechange = function() {
                                            oe.readyState === 4 && he.signal.removeEventListener("abort", ie)
                                        }
                                    ),
...
function Yr() {
    ...
    var r = typeof Map == "function" && Map.prototype,
        ...
        fe = typeof Symbol == "function" && typeof Symbol.iterator == "symbol" ? Symbol.prototype.toString : null,
        ue = typeof Symbol == "function" && typeof Symbol.iterator == "object",
        w = typeof Symbol == "function" && Symbol.toStringTag && (typeof Symbol.toStringTag === ue || !0) ? Symbol.toStringTag : null,
        F = Object.prototype.propertyIsEnumerable,
        se = (typeof Reflect == "function" ? Reflect.getPrototypeOf : Object.getPrototypeOf) || ([].__proto__ === Array.prototype ? function(m) {
                return m.__proto__
            } :
            null);

    function Z(m, U) {
        if (m === 1 / 0 || m === -1 / 0 || m !== m || m && m > -1e3 && m < 1e3 || o.call(/e/, U))
            return U;
        ...
        if (typeof m == "number") {
            ...
            if (te !== m) {
                ...
                return ee.call(re, ne, "$&_") + "." + ee.call(ee.call(_e, /([0-9]{3})/g, "$&_"), /_$/, "")
            }
        }
    ...
    zi = function m(U, ne, te, re) {
        ...
        if (Ve(_e, "maxStringLength") && (typeof _e.maxStringLength == "number" ? _e.maxStringLength < 0 && _e.maxStringLength !== 1 / 0 : _e.maxStringLength !== null))
            throw new TypeError('option "maxStringLength", if provided, must be a positive integer, Infinity, or `null`');
        var et = Ve(_e, "customInspect") ? _e.customInspect : !0;
        if (typeof et != "boolean" && et !== "symbol")
            throw new TypeError("option \"customInspect\", if provided, must be `true`, `false`, or `'symbol'`");
        if (Ve(_e, "indent") && _e.indent !== null && _e.indent !== "	" && !(parseInt(_e.indent, 10) === _e.indent && _e.indent > 0))
        ...
        function Xe(pt, wt, Lr) {
            if (wt && (re = A.call(re),
                ...
                return Ve(_e, "quoteStyle") && (j.quoteStyle = _e.quoteStyle),
                    m(pt, j, te + 1, re)
            }
        ...
        if (typeof U == "function" && !Ce(U)) {
            var yt = me(U),
                Sr = z(U, Xe);
            return "[Function" + (yt ? ": " + yt : " (anonymous)") + "]" + (Sr.length > 0 ? " { " + E.call(Sr, ", ") + " }" : "")
        }
        if (we(U)) {
            var ge = ue ? ee.call(String(U), /^(Symbol\(.*\))_[^)]*$/, "$1") : fe.call(U);
            return typeof U == "object" && !ue ? g(ge) : ge
        }
        if (ar(U)) {
            for (var lt = "<" + O.call(String(U.nodeName)), Pe = U.attributes || [], Ut = 0; Ut < Pe.length; Ut++)
        ...
        if (He(U)) {
            if (U.length === 0)
                return "[]";
            var fr = z(U, Xe);
            return ot && !_(fr) ? "[" + G(fr, ot) + "]" : "[ " + E.call(fr, ", ") + " ]"
        }
        if (xe(U)) {
            var ur = z(U, Xe);
            return !("cause" in Error.prototype) && "cause" in U && !F.call(U, "cause") ? "{ [" + String(U) + "] " + E.call(P.call("[cause]: " + Xe(U.cause), ur), ", ") + " }" : ur.length === 0 ? "[" + String(U) + "]" : "{ [" + String(U) + "] " + E.call(ur, ", ") + " }"
        }
        if (typeof U == "object" && et) {
            ...
            if (et !== "symbol" && typeof U.inspect == "function")
                return U.inspect()
        }
        if (Ne(U)) {
            var gt = [];
            return i && i.call(U, function(pt, wt) {
                    gt.push(Xe(wt, U, !0) + " => " + Xe(pt, U))
                }),
                K("Map", n.call(U), gt, ot)
        }
        if (Qe(U)) {
            var We = [];
            return l && l.call(U, function(pt) {
                    We.push(Xe(pt, U))
                }),
        ...
        if (Ye(U))
            return y("WeakRef");
        if (Se(U))
            return g(Xe(Number(U)));
        if (Me(U))
            return g(Xe($.call(U)));
        if (be(U))
            return g(I.call(U));
        if (Be(U))
            return g(Xe(String(U)));
        if (typeof window < "u" && U === window)
            return "{ [object Window] }";
        if (typeof globalThis < "u" && U === globalThis || typeof je < "u" && U === je)
            return "{ [object globalThis] }";
        if (!Te(U) && !Ce(U)) {
            var Xt = z(U, Xe),
                dr = se ? se(U) === Object.prototype : U instanceof Object || U.constructor === Object,
                Kt = U instanceof Object ? "" : "null prototype",
                ct = !dr && w && Object(U) === U && w in U ? M.call(qe(U), 8, -1) : Kt ? "Object" : "",
                vr = dr || typeof U.constructor != "function" ? "" : U.constructor.name ? U.constructor.name + " " : "",
                bt = vr + (ct || Kt ? "[" + E.call(P.call([], ct || [], Kt || []), ": ") + "] " : "");
            return Xt.length === 0 ? bt + "{}" : ot ? bt + "{" + G(Xt, ot) + "}" : bt + "{ " + E.call(Xt, ", ") + " }"
        }
        return String(U)
    };
    ...
    var Oe = Object.prototype.hasOwnProperty || function(m) {
        return m in this
    };
    ...
    function Ke(m, U) {
        if (m.indexOf)
            return m.indexOf(U);
        for (var ne = 0, te = m.length; ne < te; ne++)
            if (m[ne] === U)
                return ne;
        return -1
    }
    ...
    function Ct(m) {
        ...
        return ne ? "\\" + ne : "\\x" + (U < 16 ? "0" : "") + D.call(U.toString(16))
    }
...
` + U.prev
    ...
    function z(m, U) {
        ...
        for (var Ge in m)
            Ve(m, Ge) && (ne && String(Number(Ge)) === Ge && Ge < m.length || ue && et["$" + Ge] instanceof Symbol || (o.call(/[^\w$]/, Ge) ? te.push(U(Ge, m) + ": " + U(m[Ge], m)) : te.push(Ge + ": " + U(m[Ge], m))));
...
function oE() {
    ...
    return Ji = function() {
            var p, x = {
                assert: function(R) {
                    if (!x.has(R))
                        throw new t("Side channel does not contain " + r(R))
                },
                delete: function(R) {
                    var S = p && p.next,
                        v = e(p, R);
                    return v && S && S === v && (p = void 0),
                        !!v
                },
                get: function(R) {
                    return i(p, R)
...
function LE() {
    return So || (So = 1,
            xs = function() {
                ...
                if (e.length !== 1 || e[0] !== n || !Object.prototype.propertyIsEnumerable.call(t, n))
                    return !1;
...
function kc() {
    ...
    Ao = 1;
    var r = Dc();
    return ys = r.getPrototypeOf || null,
        ys
}
var gs, Co;
...
function CE() {
    ...
    var r = "Function.prototype.bind called on incompatible ",
        ...
        f = function(p, x) {
            for (var R = [], S = x, v = 0; S < p.length; S += 1,
                v += 1)
                R[v] = p[S];
            return R
        },
    ...
    return gs = function(p) {
            var x = this;
            if (typeof x != "function" || t.apply(x) !== i)
                throw new TypeError(r + x);
            for (var R = f(arguments, 1), S, v = function() {
                    if (this instanceof S) {
                        var k = x.apply(this, s(R, arguments));
                        return Object(k) === k ? k : this
                    }
                    return x.apply(p, s(R, arguments))
                }, d = n(0, x.length - R.length), I = [], X = 0; X < d; X++)
                I[X] = "$" + X;
            if (S = Function("binder", "return function (" + e(I, ",") + "){ return binder.apply(this,arguments); }")(v),
                x.prototype) {
                var N = function() {};
...
function Qr() {
    ...
    Bo = 1;
    var r = CE();
    return bs = Function.prototype.bind || r,
        bs
}
var ms, Uo;
...
function BE() {
    return wo || (wo = 1,
            Ss = typeof Reflect < "u" && Reflect && Reflect.apply),
        Ss
}
var ds, No;
...
function KE() {
    ...
    var i = !!n && t && t(Object.prototype, "__proto__"),
        s = Object,
        f = s.getPrototypeOf;
    return Ls = i && typeof i.get == "function" ? r([i.get]) : typeof f == "function" ? function(l) {
...
function ka() {
    ...
    var r, t = Dc(),
        ...
        ue = {
            ...
            "%MapIteratorPrototype%": typeof Map > "u" || !o || !P ? r : P(new Map()[Symbol.iterator]()),
            "%Math%": Math,
            "%Number%": Number,
            "%Object%": t,
            ...
            "%SetIteratorPrototype%": typeof Set > "u" || !o || !P ? r : P(new Set()[Symbol.iterator]()),
    ...
    var F = function Ce(xe) {
        ...
        He = function(xe) {
            ...
            var be = [];
            return T(xe, Ue, function(we, Me, Oe, Ve) {
        ...
        Te = function(xe, Be) {
            var Se = xe,
                be;
            if (he(se, Se) && (be = se[Se],
                    Se = "%" + be[0] + "%"),
                he(ue, Se)) {
                var we = ue[Se];
                if (we === W && (we = F(Se)),
                    typeof we > "u" && !Be)
                    throw new l("intrinsic " + xe + " exists, but is not available. Please file an issue!");
                return {
                    alias: be,
                    name: Se,
                    value: we
    ...
    return Bs = function(xe, Be) {
            ...
            for (var me = 1, Ke = !0; me < Se.length; me += 1) {
                ...
                if ((Ne === "constructor" || !Ke) && (Ve = !0),
                    ...
                    if (!(Ne in Oe)) {
                        if (!Be)
                            throw new l("base intrinsic for " + xe + " exists, but the property is not available.");
                        return
                    }
                    if (M && me + 1 >= Se.length) {
                        var Qe = M(Oe, Ne);
                        Ke = !!Qe,
                            Ke && "get" in Qe && !("originalValue" in Qe.get) ? Oe = Qe.get : Oe = Oe[Ne]
                    } else
                        Ke = he(Oe, Ne),
                        Oe = Oe[Ne];
                    Ke && !Ve && (ue[Me] = Oe)
...
function IE() {
    ...
    return ws = f ? function() {
            var S, v, d = {
                ...
                delete: function(I) {
                    if (f && I && (typeof I == "object" || typeof I == "function")) {
                        if (S)
                            return x(S, I)
                    } else if (i && v)
                        return v.delete(I);
                ...
                get: function(I) {
                    return f && I && (typeof I == "object" || typeof I == "function") && S ? e(S, I) : v && v.get(I)
                },
                has: function(I) {
                    return f && I && (typeof I == "object" || typeof I == "function") && S ? p(S, I) : !!v && v.has(I)
                },
                set: function(I, X) {
                    f && I && (typeof I == "object" || typeof I == "function") ? (S || (S = new f),
                        l(S, I, X)) : i && (v || (v = i()),
                        v.set(I, X))
                }
            };
...
function DE() {
    ...
    return Ns = function() {
            var l, p = {
                assert: function(x) {
                    if (!p.has(x))
                        throw new r("Side channel does not contain " + t(x))
                },
                delete: function(x) {
                    return !!l && l.delete(x)
                },
...
function jc() {
    ...
    var r = Va(),
        ...
        e = function N(k, M, ee) {
            ...
            if (typeof M != "object" && typeof M != "function") {
                if (n(k))
                    ...
                    (ee && (ee.plainObjects || ee.allowPrototypes) || !t.call(Object.prototype, M)) && (k[M] = !0);
                else
                    return [k, M];
                return k
            }
            if (!k || typeof k != "object")
                return [k].concat(M);
            var D = k;
            return n(k) && !n(M) && (D = f(k, ee)),
                n(k) && n(M) ? (M.forEach(function(O, o) {
                        if (t.call(k, o)) {
                            var P = k[o];
                            P && typeof P == "object" && O && typeof O == "object" ? k[o] = N(P, O, ee) : k.push(O)
                        } else
                            k[o] = O
                    }),
                    k) : Object.keys(M).reduce(function(O, o) {
                    var P = M[o];
                    return t.call(O, o) ? O[o] = N(O[o], P, ee) : O[o] = P,
                        O
                }, D)
        },
        l = function(k, M) {
        ...
        p = function(N, k, M) {
            var ee = N.replace(/\+/g, " ");
            if (M === "iso-8859-1")
                return ee.replace(/%[0-9a-f]{2}/gi, unescape);
            try {
        ...
        R = function(k, M, ee, D, O) {
            if (k.length === 0)
                return k;
            var o = k;
            if (typeof k == "symbol" ? o = Symbol.prototype.toString.call(k) : typeof k != "string" && (o = String(k)),
                ee === "iso-8859-1")
                return escape(o).replace(/%u[0-9a-f]{4}/gi, function(fe) {
                    return "%26%23" + parseInt(fe.slice(2), 16) + "%3B"
                });
            for (var P = "", E = 0; E < o.length; E += x) {
                for (var A = o.length >= x ? o.slice(E, E + x) : o, B = [], $ = 0; $ < A.length; ++$) {
                    var W = A.charCodeAt($);
                    if (W === 45 || W === 46 || W === 95 || W === 126 || W >= 48 && W <= 57 || W >= 65 && W <= 90 || W >= 97 && W <= 122 || O === r.RFC1738 && (W === 40 || W === 41)) {
                        B[B.length] = A.charAt($);
                        continue
                    }
                    if (W < 128) {
                    ...
                    if (W < 55296 || W >= 57344) {
                        B[B.length] = i[224 | W >> 12] + i[128 | W >> 6 & 63] + i[128 | W & 63];
                        continue
                    }
                    $ += 1,
                        W = 65536 + ((W & 1023) << 10 | A.charCodeAt($) & 1023),
                        B[B.length] = i[240 | W >> 18] + i[128 | W >> 12 & 63] + i[128 | W >> 6 & 63] + i[128 | W & 63]
                }
                P += B.join("")
            }
            return P
        ...
        S = function(k) {
            for (var M = [{
                ...
                for (var O = M[D], o = O.obj[O.prop], P = Object.keys(o), E = 0; E < P.length; ++E) {
                    var A = P[E],
                        B = o[A];
                    typeof B == "object" && B !== null && ee.indexOf(B) === -1 && (M.push({
                            obj: o,
                            prop: A
                        }),
                        ee.push(B))
        ...
        d = function(k) {
            return !k || typeof k != "object" ? !1 : !!(k.constructor && k.constructor.isBuffer && k.constructor.isBuffer(k))
        },
        I = function(k, M) {
            return [].concat(k, M)
        },
...
function OE() {
    ...
    var r = DE(),
        ...
        v = {},
        d = function X(N, k, M, ee, D, O, o, P, E, A, B, $, W, fe, ue, w, F, se) {
            for (var Z = N, he = se, oe = 0, ie = !1;
            ...
            if (typeof A == "function" ? Z = A(k, Z) : Z instanceof Date ? Z = W(Z) : M === "comma" && f(Z) && (Z = t.maybeMap(Z, function(Me) {
                    return Me instanceof Date ? W(Me) : Me
                })),
                Z === null) {
                if (O)
                    return E && !w ? E(k, R.encoder, F, "key", fe) : k;
                Z = ""
            }
            if (S(Z) || t.isBuffer(Z)) {
                if (E) {
            ...
            for (var Ce = 0; Ce < Ue.length; ++Ce) {
                var xe = Ue[Ce],
                    Be = typeof xe == "object" && xe && typeof xe.value < "u" ? xe.value : Z[xe];
                if (!(o && Be === null)) {
                    var Se = $ && P ? String(xe).replace(/\./g, "%2E") : String(xe),
                        be = f(Z) ? typeof M == "function" ? M(Te, Se) : Te : Te + ($ ? "." + Se : "[" + Se + "]");
                    se.set(N, oe);
                    var we = r();
                    we.set(v, se),
                        l(Ee, X(Be, be, M, ee, D, O, o, P, M === "comma" && w && f(Z) ? null : E, A, B, $, W, fe, ue, w, F, we))
                }
            }
            return Ee
        },
        I = function(N) {
            ...
            var O;
            if (N.arrayFormat in s ? O = N.arrayFormat : "indices" in N ? O = N.indices ? "indices" : "repeat" : O = R.arrayFormat,
                "commaRoundTrip" in N && typeof N.commaRoundTrip != "boolean")
                throw new TypeError("`commaRoundTrip` must be a boolean, or absent");
            var o = typeof N.allowDots > "u" ? N.encodeDotInKeys === !0 ? !0 : R.allowDots : !!N.allowDots;
            return {
                addQueryPrefix: typeof N.addQueryPrefix == "boolean" ? N.addQueryPrefix : R.addQueryPrefix,
                allowDots: o,
                allowEmptyArrays: typeof N.allowEmptyArrays == "boolean" ? !!N.allowEmptyArrays : R.allowEmptyArrays,
                arrayFormat: O,
                charset: k,
                charsetSentinel: typeof N.charsetSentinel == "boolean" ? N.charsetSentinel : R.charsetSentinel,
                ...
                encodeDotInKeys: typeof N.encodeDotInKeys == "boolean" ? N.encodeDotInKeys : R.encodeDotInKeys,
                encoder: typeof N.encoder == "function" ? N.encoder : R.encoder,
                encodeValuesOnly: typeof N.encodeValuesOnly == "boolean" ? N.encodeValuesOnly : R.encodeValuesOnly,
                filter: D,
                format: M,
                formatter: ee,
                serializeDate: typeof N.serializeDate == "function" ? N.serializeDate : R.serializeDate,
                skipNulls: typeof N.skipNulls == "boolean" ? N.skipNulls : R.skipNulls,
                sort: typeof N.sort == "function" ? N.sort : null,
                strictNullHandling: typeof N.strictNullHandling == "boolean" ? N.strictNullHandling : R.strictNullHandling
            }
        };
    return Os = function(X, N) {
            var k = X,
                M = I(N),
                ee, D;
            typeof M.filter == "function" ? (D = M.filter,
                k = D("", k)) : f(M.filter) && (D = M.filter,
                ee = D);
            var O = [];
            ...
            ee || (ee = Object.keys(k)),
                M.sort && ee.sort(M.sort);
            for (var E = r(), A = 0; A < ee.length; ++A) {
                var B = ee[A],
                    $ = k[B];
                M.skipNulls && $ === null || l(O, d($, B, o, P, M.allowEmptyArrays, M.strictNullHandling, M.skipNulls, M.encodeDotInKeys, M.encode ? M.encoder : null, M.filter, M.sort, M.allowDots, M.serializeDate, M.format, M.formatter, M.encodeValuesOnly, M.charset, E))
            }
            var W = O.join(M.delimiter),
                fe = M.addQueryPrefix === !0 ? "?" : "";
            return M.charsetSentinel && (M.charset === "iso-8859-1" ? fe += "utf8=%26%2310003%3B&" : fe += "utf8=%E2%9C%93&"),
                W.length > 0 ? fe + W : ""
        },
        Os
}
...
function PE() {
    ...
    var r = jc(),
        ...
        p = function(d, I) {
            ...
            if (I.charsetSentinel)
                for (D = 0; D < M.length; ++D)
                    M[D].indexOf("utf8=") === 0 && (M[D] === l ? O = "utf-8" : M[D] === e && (O = "iso-8859-1"),
                        ee = D,
                        D = M.length);
            for (D = 0; D < M.length; ++D)
                if (D !== ee) {
                    var o = M[D],
                        ...
                        E = P === -1 ? o.indexOf("=") : P + 1,
                        A, B;
                    E === -1 ? (A = I.decoder(o, i.decoder, O, "key"),
                            B = I.strictNullHandling ? null : "") : (A = I.decoder(o.slice(0, E), i.decoder, O, "key"),
                            B = r.maybeMap(f(o.slice(E + 1), I, n(X[A]) ? X[A].length : 0), function(W) {
                                return I.decoder(W, i.decoder, O, "value")
                            })),
                        B && I.interpretNumericEntities && O === "iso-8859-1" && (B = s(String(B))),
                        o.indexOf("[]=") > -1 && (B = n(B) ? [B] : B);
                    var $ = t.call(X, A);
                    $ && I.duplicates === "combine" ? X[A] = r.combine(X[A], B) : (!$ || I.duplicates === "last") && (X[A] = B)
                }
            return X
        },
        x = function(v, d, I, X) {
            ...
            for (var M = X ? d : f(d, I, N), ee = v.length - 1; ee >= 0; --ee) {
                var D, O = v[ee];
                if (O === "[]" && I.parseArrays)
                    D = I.allowEmptyArrays && (M === "" || I.strictNullHandling && M === null) ? [] : r.combine([], M);
                else {
                    D = I.plainObjects ? {
                        __proto__: null
                    } : {};
                    var o = O.charAt(0) === "[" && O.charAt(O.length - 1) === "]" ? O.slice(1, -1) : O,
                        P = I.decodeDotInKeys ? o.replace(/%2E/g, ".") : o,
                        E = parseInt(P, 10);
                    !I.parseArrays && P === "" ? D = {
                        0: M
                    } : !isNaN(E) && O !== P && String(E) === P && E >= 0 && I.parseArrays && E <= I.arrayLimit ? (D = [],
                        D[E] = M) : P !== "__proto__" && (D[P] = M)
                }
                M = D
            }
            return M
        ...
        R = function(d, I, X, N) {
            if (d) {
                var k = X.allowDots ? d.replace(/\.([^.[]+)/g, "[$1]") : d,
                    M = /(\[[^[\]]*])/,
                    ee = /(\[[^[\]]*])/g,
                    D = X.depth > 0 && M.exec(k),
                    O = D ? k.slice(0, D.index) : k,
                    o = [];
                if (O) {
                    if (!X.plainObjects && t.call(Object.prototype, O) && !X.allowPrototypes)
                        return;
                    o.push(O)
                }
                for (var P = 0; X.depth > 0 && (D = ee.exec(k)) !== null && P < X.depth;) {
                    if (P += 1,
                        !X.plainObjects && t.call(Object.prototype, D[1].slice(1, -1)) && !X.allowPrototypes)
                        return;
                    o.push(D[1])
                }
                if (D) {
        ...
        S = function(d) {
            ...
            var I = typeof d.charset > "u" ? i.charset : d.charset,
                X = typeof d.duplicates > "u" ? i.duplicates : d.duplicates;
            if (X !== "combine" && X !== "first" && X !== "last")
                throw new TypeError("The duplicates option must be either combine, first, or last");
            var N = typeof d.allowDots > "u" ? d.decodeDotInKeys === !0 ? !0 : i.allowDots : !!d.allowDots;
            return {
                allowDots: N,
                allowEmptyArrays: typeof d.allowEmptyArrays == "boolean" ? !!d.allowEmptyArrays : i.allowEmptyArrays,
                allowPrototypes: typeof d.allowPrototypes == "boolean" ? d.allowPrototypes : i.allowPrototypes,
                allowSparse: typeof d.allowSparse == "boolean" ? d.allowSparse : i.allowSparse,
                arrayLimit: typeof d.arrayLimit == "number" ? d.arrayLimit : i.arrayLimit,
                charset: I,
                charsetSentinel: typeof d.charsetSentinel == "boolean" ? d.charsetSentinel : i.charsetSentinel,
                comma: typeof d.comma == "boolean" ? d.comma : i.comma,
                decodeDotInKeys: typeof d.decodeDotInKeys == "boolean" ? d.decodeDotInKeys : i.decodeDotInKeys,
                decoder: typeof d.decoder == "function" ? d.decoder : i.decoder,
                delimiter: typeof d.delimiter == "string" || r.isRegExp(d.delimiter) ? d.delimiter : i.delimiter,
                depth: typeof d.depth == "number" || d.depth === !1 ? +d.depth : i.depth,
                duplicates: X,
                ignoreQueryPrefix: d.ignoreQueryPrefix === !0,
                interpretNumericEntities: typeof d.interpretNumericEntities == "boolean" ? d.interpretNumericEntities : i.interpretNumericEntities,
                parameterLimit: typeof d.parameterLimit == "number" ? d.parameterLimit : i.parameterLimit,
                parseArrays: d.parseArrays !== !1,
                plainObjects: typeof d.plainObjects == "boolean" ? d.plainObjects : i.plainObjects,
                strictDepth: typeof d.strictDepth == "boolean" ? !!d.strictDepth : i.strictDepth,
                strictNullHandling: typeof d.strictNullHandling == "boolean" ? d.strictNullHandling : i.strictNullHandling,
                throwOnLimitExceeded: typeof d.throwOnLimitExceeded == "boolean" ? d.throwOnLimitExceeded : !1
            }
        };
    return Ps = function(v, d) {
            var I = S(d);
            if (v === "" || v === null || typeof v > "u")
                return I.plainObjects ? {
                    __proto__: null
                } : {};
            for (var X = typeof v == "string" ? p(v, I) : v, N = I.plainObjects ? {
                    __proto__: null
                } : {}, k = Object.keys(X), M = 0; M < k.length; ++M) {
                var ee = k[M],
                    D = R(ee, X[ee], I, typeof v == "string");
                N = r.merge(N, D, I)
            }
...
function kE() {
    ...
    class s {
        ...
        async createRoom(e) {
            ...
            if (!d)
                throw new Error(`failed to create room: ${v}`);
            return new n({
                code: S.code,
                token: S.token,
                host: S.host
        ...
        async getRoom(e) {
            ...
            if (!x.ok)
                throw new Error(`unable to get room with options ${JSON.stringify(e)}: ${x.error}`);
            let R = x.body;
            return new i({
                appId: R.appId,
                appTag: R.appTag,
...
function VE() {
    ...
    Jo = 1;
    var r = null;
    return typeof WebSocket < "u" ? r = WebSocket : typeof MozWebSocket < "u" ? r = MozWebSocket : typeof je < "u" ? r = je.WebSocket || je.MozWebSocket : typeof window < "u" ? r = window.WebSocket || window.MozWebSocket : typeof self < "u" && (r = self.WebSocket || self.MozWebSocket),
        qs = r,
        qs
}
var Cr = {
...
function ME() {
    ...
    var r = typeof Reflect == "object" ? Reflect : null,
        t = r && typeof r.apply == "function" ? r.apply : function(O, o, P) {
            return Function.prototype.apply.call(O, o, P)
        },
        n;
    r && typeof r.ownKeys == "function" ? n = r.ownKeys : Object.getOwnPropertySymbols ? n = function(O) {
        ...
        f.prototype.emit = function(O) {
            ...
            if (E) {
                ...
                if (o.length > 0 && (B = o[0]),
                    B instanceof Error)
                    throw B;
                var $ = new Error("Unhandled error." + (B ? " (" + B.message + ")" : ""));
                throw $.context = B,
                    $
            }
            var W = A[O];
    ...
    function x(D, O, o, P) {
        ...
        if (l(o),
            A = D._events,
            A === void 0 ? (A = D._events = Object.create(null),
                D._eventsCount = 0) : (A.newListener !== void 0 && (D.emit("newListener", O, o.listener ? o.listener : o),
                    A = D._events),
                B = A[O]),
            B === void 0)
            B = A[O] = o,
            ++D._eventsCount;
        else if (typeof B == "function" ? B = A[O] = P ? [o, B] : [B, o] : P ? B.unshift(o) : B.push(o),
            E = p(D),
            E > 0 && B.length > E && !B.warned) {
            B.warned = !0;
            var $ = new Error("Possible EventEmitter memory leak detected. " + B.length + " " + String(O) + " listeners added. Use emitter.setMaxListeners() to increase limit");
    ...
    f.prototype.once = function(O, o) {
            return l(o),
                this.on(O, S(this, O, o)),
                this
        },
        f.prototype.prependOnceListener = function(O, o) {
            return l(o),
                this.prependListener(O, S(this, O, o)),
                this
        },
        f.prototype.removeListener = function(O, o) {
            ...
            if (P = E[O],
                ...
                return this;
            if (P === o || P.listener === o)
                --this._eventsCount === 0 ? this._events = Object.create(null) : (delete E[O],
                    E.removeListener && this.emit("removeListener", O, P.listener || o));
        ...
        f.prototype.removeAllListeners = function(O) {
            ...
            if (P.removeListener === void 0)
                return arguments.length === 0 ? (this._events = Object.create(null),
                        this._eventsCount = 0) : P[O] !== void 0 && (--this._eventsCount === 0 ? this._events = Object.create(null) : delete P[O]),
                    this;
            ...
            if (o = P[O],
                typeof o == "function")
                this.removeListener(O, o);
            else if (o !== void 0)
                for (E = o.length - 1; E >= 0; E--)
                    this.removeListener(O, o[E]);
            return this
        };
    ...
    function v(D, O, o) {
        ...
        if (P === void 0)
            return [];
        var E = P[O];
        return E === void 0 ? [] : typeof E == "function" ? o ? [E.listener || E] : [E] : o ? N(E) : I(E, E.length)
    }
    f.prototype.listeners = function(O) {
        ...
        f.listenerCount = function(D, O) {
            return typeof D.listenerCount == "function" ? D.listenerCount(O) : d.call(D, O)
        },
    ...
    function I(D, O) {
        for (var o = new Array(O), P = 0; P < O; ++P)
            o[P] = D[P];
        return o
    }
...
function $c() {
    ...
    class s extends n {
        constructor(T) {
            super(T),
                this.code = 1002,
                this.message = T && T.message ? T.message : "unable to connect to room"
        }
    }
    class f extends n {
        constructor(T) {
    ...
    class l extends e {
        constructor(T) {
            super(T),
                this.code = 2001,
                this.message = T && T.message ? T.message : "parse error in ecast protocol"
        }
    }
    class p extends e {
        constructor(T) {
    ...
    class v extends e {
        constructor(T) {
            super(T),
                this.code = 2006,
                this.message = T && T.message ? T.message : "an entity already exists with that key"
        }
    }
    class d extends e {
        constructor(T) {
            super(T),
                this.code = 2007,
                this.message = T && T.message ? T.message : "the entity is not of the expected type"
        }
    }
    class I extends e {
        constructor(T) {
    ...
    class D extends e {
        constructor(T) {
            super(T),
                this.code = 2014,
                this.message = T && T.message ? T.message : "requested role does not exist"
        }
    }
    class O extends e {
        constructor(T) {
    ...
    class B extends e {
        constructor(T) {
            super(T),
                this.code = 2021,
                this.message = T && T.message ? T.message : "text did not pass text filters"
        }
    }
    class $ extends e {
        constructor(T) {
...
function Xa() {
    ...
    class r {
        ...
        whenReceived(n) {
            if (n.entities[this.key] && n.entities[this.key] instanceof r && !this.restrictions) {
...
function $E() {
    ...
    function oe(T, V, Ee) {
        switch (T) {
            ...
            default:
                return console.error(`failed to parse result of type ${T}: ${JSON.stringify(V, null, 2)}`),
                    V
        }
    }
    ...
    class o extends n {
        ...
        connect() {
            ...
            const A = t.stringify(E),
                B = this.role === "audience" || this.id > 1e7 ? `${this.scheme}://${this.host}/api/v2/audience/${this.code}/play?${A}` : `${this.scheme}://${this.host}/api/v2/rooms/${this.code}/play?${A}`;
            return new Promise(($, W) => {
                ...
                this.conn = new r(B, "ecast-v0"),
                    this.conn.onmessage = se => {
                        this.debugLog(`recv <- ${JSON.stringify(JSON.parse(se.data), null, 2)}`);
                        const Z = ee(se);
                        if (Z instanceof d)
                            this.onReply(Z);
                            ...
                            console.error(`failed to parse response messsage: ${Z}`)
                    },
                    ...
                    this.conn.onclose = se => {
                        this.debugLog("onclose", se.code),
                            ue && se.code === 1006 ? this.reconnect() : this.emit("socketClose", se)
                    },
                    this.conn.onopen = se => {
        ...
        async reconnect() {
            ...
            for (;;)
                try {
                    ...
                    if (this.debugLog("reconnect error", B),
                    ...
                    if (A >= O) {
                        this.debugLog("reconnect failed!", B),
                            this.emit("socketClose", B);
                        return
                    }
                    E += 1,
        ...
        setRoomPassword(E) {
            return this.send("room/set-password", {
                password: E
            })
        }
        startAudience() {
        ...
        async decrementNumber(E) {
            const A = await this.send("number/decrement", {
                key: E
            });
            return this.entities[E].val = A.val,
                A
        }
        async getNumber(E) {
            const A = await this.send("number/get", {
                key: E
            });
            return this.entities[E] ? (this.entities[E].val = A.val,
                    this.entities[E].restrictions = A.restrictions) : this.entities[E] = A,
                A
        }
        async incrementNumber(E) {
            const A = await this.send("number/increment", {
                key: E
            });
            return this.entities[E].val = A.val,
                A
        ...
        async updateNumber(E, A) {
            const B = await this.send("number/update", {
                key: E,
                val: A
            });
            return this.entities[E].val = A,
                B
        }
        ...
        async getObject(E) {
            const A = await this.send("object/get", {
                key: E
            });
            return this.entities[E] ? (this.entities[E].val = A.val,
                    this.entities[E].version = A.version,
                    this.entities[E].from = A.from) : this.entities[E] = A,
                A
        }
        ...
        async updateObject(E, A) {
            const B = await this.send("object/update", {
                key: E,
                val: A
            });
            return this.entities[E] = new S({
        ...
        async updateText(E, A) {
            const B = await this.send("text/update", {
                key: E,
                val: A
            });
            return this.entities[E] = new N({
        ...
        async getDoodle(E) {
            const A = await this.send("doodle/get", {
                key: E
            });
            return this.entities[E] ? this.entities[E].lines = A.lines : this.entities[E] = A,
                A
        }
        async strokeDoodle(E, A) {
            ...
            ue && (w.brush = ue);
            const F = await this.send("doodle/stroke", {
                key: E,
                ...w
            });
            return this.entities[E].lines.push(w),
                F
        }
        async undoDoodle(E) {
            const A = await this.send("doodle/undo", {
                key: E
            });
    ...
    return Tl || (Tl = 1,
            function(r, t) {
                (function(n, i) {
                    ...
                    var i = typeof window < "u" ? window : typeof je < "u" ? je : typeof self < "u" ? self : {},
                        s = function(y, K) {
                            if (K = K.split(":")[0],
                                y = +y,
                                !y)
                    ...
                    function o(g) {
                        var y;
                        typeof window < "u" ? y = window : typeof i < "u" ? y = i : typeof self < "u" ? y = self : y = {};
                        var K = y.location || {};
                        g = g || K;
                        var _ = {},
                            C = typeof g,
                        ...
                        if (g.protocol === "blob:")
                            ...
                            for (G in g)
                                G in O || (_[G] = g[G]);
                            _.slashes === void 0 && (_.slashes = X.test(g.href))
                        }
                        return _
                    }
                    ...
                    function E(g, y) {
                        ...
                        var K = N.exec(g),
                            ...
                            z = 0,
                            m;
                        return C ? G ? (m = K[2] + K[3] + K[4],
                                z = K[2].length + K[3].length) : (m = K[2] + K[4],
                                z = K[2].length) : G ? (m = K[3] + K[4],
                                z = K[3].length) : m = K[4],
                            _ === "file:" ? z >= 2 && (m = m.slice(2)) : P(_) ? m = K[4] : _ ? C && (m = m.slice(2)) : z >= 2 && P(y.protocol) && (m = K[4]), {
                                protocol: _,
                                slashes: C || P(_),
                                slashesCount: z,
                                rest: m
                    ...
                    function A(g, y) {
                        if (g === "")
                            return y;
                        for (var K = (y || "/").split("/").slice(0, -1).concat(g.split("/")), _ = K.length, C = K[_ - 1], G = !1, z = 0; _--;)
                            K[_] === "." ? K.splice(_, 1) : K[_] === ".." ? (K.splice(_, 1),
                                z++) : z && (_ === 0 && (G = !0),
                                K.splice(_, 1),
                                z--);
                        return G && K.unshift(""),
                    ...
                    function B(g, y, K) {
                        if (g = ee(g),
                            ...
                            !(this instanceof B))
                            return new B(g, y, K);
                        var _, C, G, z, m, U, ne = D.slice(),
                            te = typeof y,
                            re = this,
                            _e = 0;
                        for (te !== "object" && te !== "string" && (K = y,
                                y = null),
                            ...
                            g = C.rest,
                            (C.protocol === "file:" && (C.slashesCount !== 2 || k.test(g)) || !C.slashes && (C.protocol || C.slashesCount < 2 || !P(re.protocol))) && (ne[3] = [/(.*)/, "pathname"]); _e < ne.length; _e++) {
                            if (z = ne[_e],
                                typeof z == "function") {
                                g = z(g, re);
                                continue
                            ...
                            G = z[0],
                                U = z[1],
                                G !== G ? re[U] = g : typeof G == "string" ? (m = G === "@" ? g.lastIndexOf(G) : g.indexOf(G),
                                    ~m && (typeof z[2] == "number" ? (re[U] = g.slice(0, m),
                                        g = g.slice(m + z[2])) : (re[U] = g.slice(m),
                                        g = g.slice(0, m)))) : (m = G.exec(g)) && (re[U] = m[1],
                                    g = g.slice(0, m.index)),
                                re[U] = re[U] || _ && z[3] && y[U] || "",
                                z[4] && (re[U] = re[U].toLowerCase())
                        }
                        K && (re.query = K(re.query)),
                            _ && y.slashes && re.pathname.charAt(0) !== "/" && (re.pathname !== "" || y.pathname !== "") && (re.pathname = A(re.pathname, y.pathname)),
                            re.pathname.charAt(0) !== "/" && P(re.protocol) && (re.pathname = "/" + re.pathname),
                            s(re.port, re.protocol) || (re.host = re.hostname,
                                re.port = ""),
                            re.username = re.password = "",
                            re.auth && (m = re.auth.indexOf(":"),
                                ~m ? (re.username = re.auth.slice(0, m),
                                    re.username = encodeURIComponent(decodeURIComponent(re.username)),
                                    re.password = re.auth.slice(m + 1),
                                    re.password = encodeURIComponent(decodeURIComponent(re.password))) : re.username = encodeURIComponent(decodeURIComponent(re.auth)),
                                re.auth = re.password ? re.username + ":" + re.password : re.username),
                            re.origin = re.protocol !== "file:" && P(re.protocol) && re.host ? re.protocol + "//" + re.host : "null",
                            re.href = re.toString()
                    }
                    ...
                    function $(g, y, K) {
                        ...
                        switch (g) {
                            ...
                            case "port":
                                _[g] = y,
                                    s(y, _.protocol) ? y && (_.host = _.hostname + ":" + y) : (_.host = _.hostname,
                                        _[g] = "");
                                break;
                            case "hostname":
                                _[g] = y,
                            ...
                            case "host":
                                _[g] = y,
                                    /:\d+$/.test(y) ? (y = y.split(":"),
                                        _.port = y.pop(),
                                        _.hostname = y.join(":")) : (_.hostname = y,
                                        _.port = "");
                                break;
                            case "protocol":
                                _.protocol = y.toLowerCase(),
                                    _.slashes = !K;
                                break;
                            case "pathname":
                            case "hash":
                            ...
                            case "auth":
                                var G = y.indexOf(":");
                                ~G ? (_.username = y.slice(0, G),
                                    _.username = encodeURIComponent(decodeURIComponent(_.username)),
                                    _.password = y.slice(G + 1),
                                    _.password = encodeURIComponent(decodeURIComponent(_.password))) : _.username = encodeURIComponent(decodeURIComponent(y))
                        }
                        for (var z = 0; z < D.length; z++) {
                            var m = D[z];
                            m[4] && (_[m[1]] = _[m[1]].toLowerCase())
                        }
                        return _.auth = _.password ? _.username + ":" + _.password : _.username,
                            _.origin = _.protocol !== "file:" && P(_.protocol) && _.host ? _.protocol + "//" + _.host : "null",
                            _.href = _.toString(),
                            _
                    }
                    ...
                    function W(g) {
                        ...
                        var G = C + (K.protocol && K.slashes || P(K.protocol) ? "//" : "");
                        return K.username ? (G += K.username,
                                K.password && (G += ":" + K.password),
                                G += "@") : K.password ? (G += ":" + K.password,
                                G += "@") : K.protocol !== "file:" && P(K.protocol) && !_ && K.pathname !== "/" && (G += "@"),
                            _[_.length - 1] === ":" && (_ += ":"),
                            G += _ + K.pathname,
                    ...
                    Z.prototype.addEventListener = function(y, K) {
                            typeof K == "function" && (Array.isArray(this.listeners[y]) || (this.listeners[y] = []),
                        ...
                        Z.prototype.dispatchEvent = function(y) {
                            ...
                            var G = y.type,
                                z = this.listeners[G];
                            return Array.isArray(z) ? (z.forEach(function(m) {
                    ...
                    oe.prototype.attachWebSocket = function(y, K) {
                            ...
                            if (C && C.server && C.websockets.indexOf(y) === -1)
                                return C.websockets.push(y),
                                    C.server
                        },
                        oe.prototype.addMembershipToRoom = function(y, K) {
                            var _ = this.urlMap[he(y.url)];
                            _ && _.server && _.websockets.indexOf(y) !== -1 && (_.roomMemberships[K] || (_.roomMemberships[K] = []),
                        ...
                        oe.prototype.removeWebSocket = function(y, K) {
                            var _ = he(K),
                                C = this.urlMap[_];
                            C && (C.websockets = F(C.websockets, function(G) {
                                return G === y
                            }))
                        },
                        oe.prototype.removeMembershipFromRoom = function(y, K) {
                            ...
                            _ && C !== null && (_.roomMemberships[K] = F(C, function(G) {
                                return G === y
                            }))
                        };
                    var ie = new oe,
                    ...
                    function be(g) {
                        return Object.prototype.toString.call(g) !== "[object Blob]" && !(g instanceof ArrayBuffer) && (g = String(g)),
                            g
                    }
                    var we = new WeakMap;
                    ...
                    function Ve(g) {
                        ...
                        if (K || (y.pathname = "/"),
                            _ === "")
                            throw new SyntaxError(V.CONSTRUCTOR_ERROR + " The URL '" + y.toString() + "' is invalid.");
                        if (_ !== "ws:" && _ !== "wss:")
                            throw new SyntaxError(V.CONSTRUCTOR_ERROR + " The URL's scheme must be either 'ws' or 'wss'. '" + _ + "' is not allowed.");
                        if (C !== "")
                            throw new SyntaxError(V.CONSTRUCTOR_ERROR + " The URL contains a fragment identifier ('" + C + "'). Fragment identifiers are not allowed in WebSocket URLs.");
                        return y.toString()
                    }
                    ...
                    function qe(g) {
                        if (g === void 0 && (g = []),
                            ...
                            throw new SyntaxError(V.CONSTRUCTOR_ERROR + " The subprotocol '" + g.toString() + "' is invalid.");
                        typeof g == "string" && (g = [g]);
                        var y = g.map(function(_) {
                                return {
                                    count: 1,
                                    protocol: _
                                }
                            }).reduce(function(_, C) {
                                return _[C.protocol] = (_[C.protocol] || 0) + C.count,
                                    _
                            }, {}),
                        ...
                        if (K.length > 0)
                            throw new SyntaxError(V.CONSTRUCTOR_ERROR + " The subprotocol '" + K[0] + "' is duplicated.");
                        return g
                    }
                    var me = function(g) {
                        function y(_, C) {
                            ...
                            ue(function() {
                                if (this.readyState === y.CONNECTING)
                                    if (z)
                                        if (z.options.verifyClient && typeof z.options.verifyClient == "function" && !z.options.verifyClient())
                                            ...
                                            if (z.options.selectProtocol && typeof z.options.selectProtocol == "function") {
                        ...
                        return K.onopen.get = function() {
                            ...
                            y.prototype.close = function(C, G) {
                                if (C !== void 0 && (typeof C != "number" || C !== 1e3 && (C < 3e3 || C > 4999)))
                                    throw new TypeError(V.CLOSE_ERROR + " The code must be either 1000, or between 3000 and 4999. " + C + " is neither.");
                                if (G !== void 0) {
                                    var z = Oe(G);
                                    if (z > 123)
                                ...
                                if (!(this.readyState === y.CLOSING || this.readyState === y.CLOSED)) {
                                    var m = Me(this);
                                    this.readyState === y.CONNECTING ? Se(m, C || T.CLOSE_ABNORMAL, G) : Be(m, C || T.CLOSE_NO_STATUS, G)
                                }
                            },
                    ...
                    var Ke = function(g) {
                        function y(_, C) {
                            ...
                            z.pathname || (z.pathname = "/"),
                                ...
                                this.protocol = "",
                                this.target = this,
                                typeof C == "string" || typeof C == "object" && C !== null ? this.protocol = C : Array.isArray(C) && C.length > 0 && (this.protocol = C[0]);
                            var m = ie.attachWebSocket(this, this.url);
                            ue(function() {
                                    m ? (this.readyState = y.OPEN,
                                        m.dispatchEvent(Te({
                                            type: "connection"
                                        }), m, this),
                                        m.dispatchEvent(Te({
                        ...
                        return y.prototype.close = function() {
                                if (this.readyState === y.OPEN) {
                                    var C = ie.serverLookup(this.url);
                                    return ie.removeWebSocket(this, this.url),
                                        this.readyState = y.CLOSED,
                                        this.dispatchEvent(xe({
                                            type: "close",
                                            target: this,
                            ...
                            y.prototype.emit = function(C) {
                                ...
                                return U && U.dispatchEvent.apply(U, [m].concat(G)),
                                    this
                            },
                            y.prototype.send = function(C) {
                                return this.emit("message", C),
                                    this
                            },
                            ...
                            y.prototype.on = function(C, G) {
                                return this.addEventListener(C, G),
                                    this
                            },
                            ...
                            y.prototype.dispatchEvent = function(C) {
                                ...
                                ne.forEach(function(te) {
                                    z.length > 0 ? te.apply(G, z) : te.call(G, C.data ? C.data : C)
                                })
                            },
                            Object.defineProperties(y.prototype, K),
                            y
                    ...
                    function Ye() {
                        return typeof window < "u" ? window : typeof process == "object" && typeof zE == "function" && typeof je == "object" ? je : this
                    }
                    var Qe = {
                            mock: !0,
                            verifyClient: null,
                        ...
                        Rt = function(g) {
                            ...
                            return g && (y.__proto__ = g),
                                ...
                                y.prototype.mockWebsocket = function() {
                                    var _ = Ye();
                                    this.originalWebSocket = _.WebSocket,
                                        _.WebSocket = me
                                },
                                y.prototype.restoreWebsocket = function() {
                                    var _ = Ye();
                                    this.originalWebSocket !== null && (_.WebSocket = this.originalWebSocket),
                                        this.originalWebSocket = null
                                },
                                ...
                                y.prototype.emit = function(_, C, G) {
                                    ...
                                    var U;
                                    typeof G != "object" || arguments.length > 3 ? (C = Array.prototype.slice.call(arguments, 1, arguments.length),
                                            U = C.map(function(ne) {
                                                return be(ne)
                                            })) : U = be(C),
                                        m.forEach(function(ne) {
                                            var te = ne instanceof Ke ? C : U;
                                            Array.isArray(te) ? ne.dispatchEvent.apply(ne, [Ce({
                                                type: _,
                                                data: te,
                                                origin: z.url,
                                                target: ne.target
                                            })].concat(te)) : ne.dispatchEvent(Ce({
                                                type: _,
                                                data: te,
                                                origin: z.url,
                                                target: ne.target
...
function ZE() {
    ...
    let e = class {
        static isSurrogate(p, x) {
            return 55296 <= p.charCodeAt(x) && p.charCodeAt(x) <= 56319 && 56320 <= p.charCodeAt(x + 1) && p.charCodeAt(x + 1) <= 57343
        }
        static codePointAt(p, x) {
            ...
            if (55296 <= R && R <= 56319 && x < p.length - 1) {
                const S = R,
                    v = p.charCodeAt(x + 1);
                return 56320 <= v && v <= 57343 ? (S - 55296) * 1024 + (v - 56320) + 65536 : S
            }
            if (56320 <= R && R <= 57343 && x >= 1) {
                const S = p.charCodeAt(x - 1),
                    v = R;
                return 55296 <= S && S <= 56319 ? (S - 55296) * 1024 + (v - 56320) + 65536 : v
            }
            return R
        }
        static shouldBreak(p, x, R, S, v, d) {
            const I = [p].concat(x).concat([R]),
                X = [S].concat(v).concat([d]),
                N = I[I.length - 2],
                k = R,
                M = d,
                ee = I.lastIndexOf(r.CLUSTER_BREAK.REGIONAL_INDICATOR);
            if (ee > 0 && I.slice(1, ee).every(function(O) {
                    return O === r.CLUSTER_BREAK.REGIONAL_INDICATOR
                }) && [r.CLUSTER_BREAK.PREPEND, r.CLUSTER_BREAK.REGIONAL_INDICATOR].indexOf(N) === -1)
                return I.filter(function(O) {
                    return O === r.CLUSTER_BREAK.REGIONAL_INDICATOR
                }).length % 2 === 1 ? s : f;
            if (N === r.CLUSTER_BREAK.CR && k === r.CLUSTER_BREAK.LF)
                return t;
            if (N === r.CLUSTER_BREAK.CONTROL || N === r.CLUSTER_BREAK.CR || N === r.CLUSTER_BREAK.LF)
                return n;
            if (k === r.CLUSTER_BREAK.CONTROL || k === r.CLUSTER_BREAK.CR || k === r.CLUSTER_BREAK.LF)
                return n;
            if (N === r.CLUSTER_BREAK.L && (k === r.CLUSTER_BREAK.L || k === r.CLUSTER_BREAK.V || k === r.CLUSTER_BREAK.LV || k === r.CLUSTER_BREAK.LVT))
                return t;
            if ((N === r.CLUSTER_BREAK.LV || N === r.CLUSTER_BREAK.V) && (k === r.CLUSTER_BREAK.V || k === r.CLUSTER_BREAK.T))
                return t;
            if ((N === r.CLUSTER_BREAK.LVT || N === r.CLUSTER_BREAK.T) && k === r.CLUSTER_BREAK.T)
                return t;
            if (k === r.CLUSTER_BREAK.EXTEND || k === r.CLUSTER_BREAK.ZWJ)
                return t;
            if (k === r.CLUSTER_BREAK.SPACINGMARK)
                return t;
            if (N === r.CLUSTER_BREAK.PREPEND)
                return t;
            const D = X.slice(0, -1).lastIndexOf(r.EXTENDED_PICTOGRAPHIC);
            return D !== -1 && X[D] === r.EXTENDED_PICTOGRAPHIC && I.slice(D + 1, -2).every(function(O) {
                return O === r.CLUSTER_BREAK.EXTEND
            }) && N === r.CLUSTER_BREAK.ZWJ && M === r.EXTENDED_PICTOGRAPHIC ? t : x.indexOf(r.CLUSTER_BREAK.REGIONAL_INDICATOR) !== -1 ? i : N === r.CLUSTER_BREAK.REGIONAL_INDICATOR && k === r.CLUSTER_BREAK.REGIONAL_INDICATOR ? t : n
        }
    };
    return Br.default = e,
        Br
...
function th() {
    if (Al)
        return Ht;
    Al = 1;
    var r = Ht && Ht.__importDefault || function(f) {
    ...
    class s {
        static nextBreak(e, l) {
            ...
            for (let d = l + 1; d < e.length; d++) {
                if (n.default.isSurrogate(e, d - 1))
                    continue;
                const I = n.default.codePointAt(e, d),
                    X = s.getGraphemeBreakProperty(I),
                    N = s.getEmojiProperty(I);
                if (n.default.shouldBreak(x, S, X, R, v, N))
                    return d;
                S.push(X),
                    v.push(N)
            }
        ...
        splitGraphemes(e) {
            ...
            let p = 0,
                x;
            for (;
                (x = s.nextBreak(e, p)) < e.length;)
                l.push(e.slice(p, x)),
                p = x;
            return p < e.length && l.push(e.slice(p)),
                l
        }
        iterateGraphemes(e) {
...
function rh() {
    if (Cl)
        return Ft;
    Cl = 1;
    var r = Ft && Ft.__importDefault || function(n) {
...
function Qa(r) {
    return r === null || Ya(r) || typeof r != "object" && typeof r != "function"
}
...
function ch(r) {
    return Yt(r) && "nativeEvent" in r && "preventDefault" in r && "stopPropagation" in r
}
...
function Ul(r, t) {
    ...
    for (let i = 0; i < r.length; i++) {
        const s = r[i];
        try {
            t0(s) ? n.push("[VueViewModel]") : n.push(String(s))
        } catch {
...
function ph(r, t, n = !1) {
    return ht(r) ? lh(t) ? t.test(r) : ht(t) ? n ? r === t : r.includes(t) : !1 : !1
}

function tn(r, t = [], n = !1) {
    return t.some(i => ph(r, i, n))
}

function Eh(r, t, n = 250, i, s, f, e) {
    if (!f.exception || !f.exception.values || !e || !Dt(e.originalException, Error))
        return;
    const l = f.exception.values.length > 0 ? f.exception.values[f.exception.values.length - 1] : void 0;
    l && (f.exception.values = hh(Ra(r, t, s, e.originalException, i, f.exception.values, l, 0), n))
}
...
function Ra(r, t, n, i, s, f, e, l) {
    ...
    if (Dt(i[s], Error)) {
        ...
        const x = r(t, i[s]),
            R = p.length;
        wl(x, s, R, l),
            p = Ra(r, t, n, i[s], s, [x, ...p], x, R)
    }
    return Array.isArray(i.errors) && i.errors.forEach((x, R) => {
            if (Dt(x, Error)) {
                Kl(e, l);
                const S = r(t, x),
                    v = p.length;
                wl(S, `errors[${R}]`, v, l),
                    p = Ra(r, t, n, x, s, [S, ...p], S, v)
            }
        }),
        p
}
...
function hh(r, t) {
    return r.map(n => (n.value && (n.value = Jt(n.value, t)),
        n))
}
...
function n0(r, t = {}) {
    ...
    try {
        ...
        const R = Array.isArray(t) ? t : t.keyAttrs,
            S = !Array.isArray(t) && t.maxStringLength || xh;
        for (; n && f++ < i && (x = _h(n, R),
...
function _h(r, t) {
    ...
    const s = t && t.length ? t.filter(e => n.getAttribute(e)).map(e => [e, n.getAttribute(e)]) : null;
    if (s && s.length)
        s.forEach(e => {
            i.push(`[${e[0]}="${e[1]}"]`)
        });
...
function Sh(r) {
    ...
    let p = "",
        x = l;
    const R = x.split("/");
    if (R.length > 1 && (p = R.slice(0, -1).join("/"),
            x = R.pop()),
        x) {
        const S = x.match(/^\d+/);
        S && (x = S[0])
...
function dh(r) {
    ...
    return ["protocol", "publicKey", "host", "projectId"].find(e => r[e] ? !1 : (Re.error(`Invalid Sentry Dsn: ${e} missing`),
        !0)) ? !1 : n.match(/^\d+$/) ? Th(i) ? t && isNaN(parseInt(t, 10)) ? (Re.error(`Invalid Sentry Dsn: Invalid port ${t}`),
        !1) : !0 : (Re.error(`Invalid Sentry Dsn: Invalid protocol ${i}`),
        !1) : (Re.error(`Invalid Sentry Dsn: Invalid projectId ${n}`),
        !1)
}

function vh(r) {
    const t = typeof r == "string" ? Sh(r) : i0(r);
    if (!(!t || !dh(t)))
        return t
}
...
function s0(r, t) {
    try {
        const n = t.prototype || {};
        r.prototype = t.prototype = n,
            Ot(r, "__sentry_original__", t)
    } catch {}
}
...
function Lh(r) {
    return Object.keys(r).map(t => `${encodeURIComponent(t)}=${encodeURIComponent(r[t])}`).join("&")
}
...
function a0(r) {
    ...
    if (Zr(r)) {
        const t = {
            type: r.type,
            target: Nl(r.target),
            currentTarget: Nl(r.currentTarget),
            ...Il(r)
        };
        return typeof CustomEvent < "u" && Dt(r, CustomEvent) && (t.detail = r.detail),
            t
    } else
        return r
}
...
function Nl(r) {
    try {
        return oh(r) ? n0(r) : Object.prototype.toString.call(r)
    } catch {
        return "<unknown>"
    }
}
...
const f0 = 50,
    Pt = "?",
    Dl = /\(error: (.*)\)/,
    Ol = /captureMessage|captureException/;
...
`);
        for (let l = i; l < e.length; l++) {
            ...
            if (p.length > 1024)
                continue;
            const x = Dl.test(p) ? p.replace(Dl, "$1") : p;
            if (!x.match(/\S*Error: /)) {
                for (const R of t) {
                    const S = R(x);
                    if (S) {
...
function Uh(r) {
    ...
    return /sentryWrapped/.test(Kr(t).function || "") && t.pop(),
        t.reverse(),
        Ol.test(Kr(t).function || "") && (t.pop(),
            Ol.test(Kr(t).function || "") && t.pop()),
        t.slice(0, f0).map(n => ({
            ...n,
    ...
    if (n)
        for (const i of n)
            try {
                ...
                ir && Re.error(`Error while triggering instrumentation handler.
Type: ${r}
Name: ${Lt(i)}
Error:`, s)
            }
...
function wh() {
    "console" in ve && ya.forEach(function(r) {
        r in ve.console && Ze(ve.console, r, function(t) {
            return qr[r] = t,
                function(...n) {
                    at("console", {
                        args: n,
    ...
    if (t && typeof t.createElement == "function")
        try {
            ...
            n.hidden = !0,
                ...
                n.contentWindow && n.contentWindow.fetch && (r = ma(n.contentWindow.fetch)),
                t.head.removeChild(n)
        } catch (n) {
            ir && Re.warn("Could not create sandbox iframe for pure fetch check, bailing to window.fetch: ", n)
        }
    return r
}
const l0 = 1e3;
...
function Oh(r, t = !1) {
    t && !Nh() || Ze(ve, "fetch", function(n) {
        return function(...i) {
            ...
            return n.apply(ve, i).then(async p => (at("fetch", {
                    ...e,
                    endTimestamp: xt() * 1e3,
                    response: p
                }),
...
function Vl(r) {
    return typeof r == "string" ? r : r ? Ta(r, "url") ? r.url : r.toString ? r.toString() : "" : ""
}
...
function qh() {
    Nr = ve.onunhandledrejection,
        ve.onunhandledrejection = function(r) {
            return at("unhandledrejection", r),
...
function E0(r, t = 3, n = 100 * 1024) {
    const i = vt(r, t);
    return Hh(i) > n ? E0(r, t - 1, n) : i
}
...
function da(r, t, n = 1 / 0, i = 1 / 0, s = jh()) {
    ...
    if (t.__sentry_skip_normalization__)
        return t;
    const p = typeof t.__sentry_override_normalization_depth__ == "number" ? t.__sentry_override_normalization_depth__ : n;
    if (p === 0)
...
class rt {
    ...
    __init4() {
        this._executeHandlers = () => {
            ...
            this._handlers = [],
                t.forEach(n => {
                    n[0] || (this._state === Et.RESOLVED && n[1](this._value),
...
const zh = ["fatal", "error", "warning", "log", "info", "debug"];

function Jh(r) {
    return r === "warn" ? "warning" : zh.includes(r) ? r : "log"
}
const Yh = "sentry-",
    Qh = /^sentry-/;
...
function ex(r) {
    if (!(!r || !ht(r) && !Array.isArray(r)))
        return Array.isArray(r) ? r.reduce((t, n) => {
            const i = ql(n);
            return Object.entries(i).forEach(([s, f]) => {
                    t[s] = f
                }),
                t
        }, {}) : ql(r)
...
function ql(r) {
    return r.split(",").map(t => t.split("=").map(n => decodeURIComponent(n.trim()))).reduce((t, [n, i]) => (n && i && (t[n] = i),
        t), {})
}
...
function va(r) {
    return ve.__SENTRY__ && ve.__SENTRY__.encodePolyfill ? ve.__SENTRY__.encodePolyfill(r) : new TextEncoder().encode(r)
}
...
function rx(r) {
    ...
    function s(f) {
        typeof i == "string" ? i = typeof f == "string" ? i + f : [va(i), f] : i.push(typeof f == "string" ? va(f) : f)
    }
    for (const f of n) {
        const [e, l] = f;
        if (s(`
...
function ax(r, t, n, i) {
    const s = r.sdkProcessingMetadata && r.sdkProcessingMetadata.dynamicSamplingContext;
    return {
        event_id: r.event_id,
...
function ox(r, t = Date.now()) {
    const n = parseInt(`${r}`, 10);
    if (!isNaN(n))
        return n * 1e3;
    const i = Date.parse(`${r}`);
    return isNaN(i) ? ux : i - t
}
...
function px(r, {
    ...
    if (f)
        for (const l of f.trim().split(",")) {
            const [p, x, , , R] = l.split(":", 5), S = parseInt(p, 10), v = (isNaN(S) ? 60 : S) * 1e3;
            if (!x)
                s.all = i + v;
            else
                for (const d of x.split(";"))
                    d === "metric_bucket" ? (!R || R.split(";").includes("custom")) && (s[d] = i + v) : s[d] = i + v
        }
    else
        e ? s.all = i + ox(e, i) : t === 429 && (s.all = i + 60 * 1e3);
    return s
}
...
function Qt(r, t = {}) {
    if (t.user && (!r.ipAddress && t.user.ip_address && (r.ipAddress = t.user.ip_address),
            !r.did && !t.did && (r.did = t.user.id || t.user.email || t.user.username)),
...
class rf {
    ...
    setUser(t) {
        return this._user = t || {
            ...
            this._session && Qt(this._session, {
                user: t
            }),
    ...
    update(t) {
        ...
        const n = typeof t == "function" ? t(this) : t,
            [i, s] = n instanceof Vt ? [n.getScopeData(), n.getRequestSession()] : Yt(n) ? [t, t.requestSession] : [],
            {
                tags: f,
                extra: e,
                user: l,
    ...
    captureEvent(t, n) {
        ...
        return this._client ? (this._client.captureEvent(t, {
            ...
            i) : (Re.warn("No client configured on scope - will not capture event!"),
            i)
    }
...
class mx {
    ...
    withScope(t) {
        ...
        return en(i) ? i.then(s => (this._popScope(),
            s), s => {
            throw this._popScope(),
                s
        }) : (this._popScope(),
...
function Zt() {
    const r = sn(),
        t = tf(r);
    return t.stack = t.stack || new mx(gx(), bx())
}
...
function Sx(r, t) {
    const n = Zt();
    return n.withScope(() => (n.getStackTop().scope = r,
        t(r)))
}
...
function dx() {
    return {
        withIsolationScope: Wl,
        withScope: Tx,
        withSetScope: Sx,
        withSetIsolationScope: (r, t) => Wl(t),
...
const Bx = "sentry.source",
    Ux = "sentry.sample_rate",
    Kx = "sentry.op",
    wx = "sentry.origin",
    Nx = 0,
    Ix = 1,
...
function zl(r) {
    return typeof r == "number" ? Jl(r) : Array.isArray(r) ? r[0] + r[1] / 1e9 : r instanceof Date ? Jl(r.getTime()) : xt()
}
    ...
    try {
        ...
        if (Px(r)) {
            ...
            return nt({
                ...
                description: f,
                parent_span_id: l,
                start_timestamp: zl(s),
                timestamp: zl(e) || void 0,
                status: Mx(p),
                op: i[Kx],
                origin: i[wx],
                _metrics_summary: Cx(r)
            })
        }
        return {
            span_id: t,
...
function Mx(r) {
    if (!(!r || r.code === Nx))
        return r.code === Ix ? "ok" : r.message || "unknown_error"
}
const qx = "_sentryRootSpan";
...
function Xx(r) {
    ...
    const S = x[Bx],
        v = p.description;
    return S !== "url" && v && (n.transaction = v),
        Gx() && (n.sampled = String(Vx(i))),
...
function $x(r) {
    ...
    if (typeof t != "number" || isNaN(t) || t < 0 || t > 1) {
        Le && Re.warn(`[Tracing] Given sample rate is invalid. Sample rate must be a boolean or a number between 0 and 1. Got ${JSON.stringify(r)} of type ${JSON.stringify(typeof r)}.`);
        return
    }
    return t
}
...
function Fx(r, t) {
    return t && (r.sdk = r.sdk || {},
            r.sdk.name = r.sdk.name || t.name,
            r.sdk.version = r.sdk.version || t.version,
            r.sdk.integrations = [...r.sdk.integrations || [], ...t.integrations || []],
...
function Aa(r, t, n, i = 0) {
    return new rt((s, f) => {
        const e = r[i];
        if (t === null || typeof e != "function")
            s(t);
        else {
            const l = e({
                ...t
            }, n);
            Le && e.id && l === null && Re.log(`Event processor "${e.id}" dropped event`),
                en(l) ? l.then(p => Aa(r, p, n, i + 1).then(s)).then(null, f) : Aa(r, l, n, i + 1).then(s).then(null, f)
        }
    })
}
...
function Jx(r, t) {
    ...
    p && Object.keys(p).length && (r.extra = {
        ...p,
        ...r.extra
    });
    const x = nt(i);
    x && Object.keys(x).length && (r.tags = {
        ...x,
        ...r.tags
    });
    const R = nt(s);
    R && Object.keys(R).length && (r.user = {
        ...R,
        ...r.user
    });
    const S = nt(f);
    S && Object.keys(S).length && (r.contexts = {
            ...S,
            ...r.contexts
        }),
        e && (r.level = e),
...
function t_(r, t, n, i, s, f) {
    ...
    r_(p, r),
        ...
        t.type === void 0 && n_(p, r.stackParser);
    const R = f_(i, n.captureContext);
    ...
    return Aa(I, p, n).then(N => (N && i_(N),
        typeof e == "number" && e > 0 ? a_(N, e, l) : N))
}
...
function a_(r, t, n) {
    ...
    const i = {
        ...
        ...r.contexts && {
            contexts: vt(r.contexts, t, n)
        },
        ...r.extra && {
            extra: vt(r.extra, t, n)
        }
    };
    return r.contexts && r.contexts.trace && i.contexts && (i.contexts.trace = r.contexts.trace,
            r.contexts.trace.data && (i.contexts.trace.data = vt(r.contexts.trace.data, t, n))),
        r.spans && (i.spans = r.spans.map(s => ({
            ...s,
            ...s.data && {
                data: vt(s.data, t, n)
            }
...
function p_(r) {
    return `${c_(r)}${r.projectId}/envelope/`
}
...
function __(r) {
    ...
    let i;
    Array.isArray(n) ? i = [...t, ...n] : typeof n == "function" ? i = p0(n(t)) : i = t;
    const s = x_(i),
...
function tc(r, t) {
    for (const n of t)
        n && n.afterAllSetup && n.afterAllSetup(r)
}

function m0(r, t, n) {
    if (n[t.name]) {
        Le && Re.log(`Integration skipped because it was already installed: ${t.name}`);
        return
    }
    if (n[t.name] = t,
...
class y_ {
    constructor(t) {
        if (this._options = t,
            ...
            this._hooks = {},
            this._eventProcessors = [],
            t.dsn ? this._dsn = vh(t.dsn) : Le && Re.warn("No DSN provided, client will not send events."),
            this._dsn) {
            const n = h_(this._dsn, t.tunnel, t._metadata ? t._metadata.sdk : void 0);
    ...
    captureException(t, n, i) {
        ...
        return this._process(this.eventFromException(t, f).then(e => this._captureEvent(e, f, i))),
            f.event_id
    }
    captureMessage(t, n, i, s) {
        const f = {
            ...
            e = Ya(t) ? t : String(t),
            l = Qa(t) ? this.eventFromMessage(e, n, f) : this.eventFromException(t, f);
        return this._process(l.then(p => this._captureEvent(p, f, s))),
            f.event_id
    }
    captureEvent(t, n, i) {
        const s = it();
        if (n && n.originalException && Ml(n.originalException))
            return Le && Re.log(rc),
                s;
        const f = {
                event_id: s,
        ...
        return this._process(this._captureEvent(t, f, l || i)),
            f.event_id
    }
    captureSession(t) {
        typeof t.release != "string" ? Le && Re.warn("Discarded session because of missing or non-string release") : (this.sendSession(t),
            Qt(t, {
                init: !1
            }))
    }
    ...
    flush(t) {
        ...
        return n ? (this.emit("flush"),
            this._isClientDoneProcessing(t).then(i => n.flush(t).then(s => i && s))) : kt(!0)
    }
    close(t) {
    ...
    addIntegration(t) {
        ...
        m0(this, t, this._integrations),
            n || tc(this, [t])
    }
    sendEvent(t, n = {}) {
        this.emit("beforeSendEvent", t, n);
        let i = Wx(t, this._dsn, this._options._metadata, this._options.tunnel);
    ...
    sendSession(t) {
        const n = Hx(t, this._dsn, this._options._metadata, this._options.tunnel);
        this.sendEnvelope(n)
    }
    ...
    sendEnvelope(t) {
        return this.emit("beforeEnvelope", t),
            this._isEnabled() && this._transport ? this._transport.send(t).then(null, n => (Le && Re.error("Error while sending envelope:", n),
                n)) : (Le && Re.error("Transport disabled"),
                kt({}))
    }
    _setupIntegrations() {
        const {
    ...
    _isClientDoneProcessing(t) {
        return new rt(n => {
            ...
            const s = 1,
                f = setInterval(() => {
                    this._numProcessing == 0 ? (clearInterval(f),
                        n(!0)) : (i += s,
                        t && i >= t && (clearInterval(f),
                            n(!1)))
                }, s)
        })
    }
    ...
    _captureEvent(t, n = {}, i) {
        return this._processEvent(t, n, i).then(s => s.event_id, s => {
            if (Le) {
                const f = s;
    ...
    _processEvent(t, n, i) {
        const s = this.getOptions(),
            ...
            R = typeof f > "u" ? void 0 : $x(f);
        if (l && typeof R == "number" && Math.random() > R)
            return this.recordDroppedEvent("sample_rate", "error", t),
                Gr(new ut(`Discarding event because it's not included in the random sample (sampling rate = ${f})`, "log"));
        const S = p === "replay_event" ? "replay" : p,
            d = (t.sdkProcessingMetadata || {}).capturedSpanIsolationScope;
        return this._prepareEvent(t, n, i, d).then(I => {
            if (I === null)
                throw this.recordDroppedEvent("event_processor", S, t),
                    new ut("An event processor returned `null`, will not send event.", "log");
            if (n.data && n.data.__sentry__ === !0)
                return I;
            const N = b_(this, s, I, n);
            return g_(N, x)
        }).then(I => {
            if (I === null) {
                if (this.recordDroppedEvent("before_send", S, t),
                    e) {
            ...
            const X = i && i.getSession();
            if (!e && X && this._updateSessionFromEvent(X, I),
                e) {
                const k = I.sdkProcessingMetadata && I.sdkProcessingMetadata.spanCountBeforeProcessing || 0,
            ...
            return this.sendEvent(I, n),
                I
        }).then(null, I => {
            throw I instanceof ut ? I : (this.captureException(I, {
                    data: {
                        __sentry__: !0
                    },
                    originalException: I
...
Reason: ${I}`))
    ...
    _flushOutcomes() {
        ...
        const n = fx(t, this._options.tunnel && nn(this._dsn));
        this.sendEnvelope(n)
    }
}
...
function d_(r, t, n = Wh(r.bufferSize || S_)) {
    let i = {};
    const s = e => n.drain(e);
    ...
    function f(e) {
        ...
        const p = mr(e[0], l),
            ...
            R = () => t({
                body: rx(p)
            }).then(S => (S.statusCode !== void 0 && (S.statusCode < 200 || S.statusCode >= 300) && Le && Re.warn(`Sentry responded with status code ${S.statusCode} to sent event.`),
                i = px(i, S),
                S), S => {
                throw x("network_error"),
                    S
            });
        return n.add(R).then(S => S, S => {
            if (S instanceof ut)
                return Le && Re.error("Skipped sending event because buffer is full."),
                    x("queue_overflow"),
                    kt({});
            throw S
        })
...
function Mt(r, t) {
    ...
    const l = {
        ...
        p = s ? gr(() => s(l, t)) : l;
    p !== null && (n.emit && n.emit("beforeAddBreadcrumb", p, t),
        i.addBreadcrumb(p, f))
}
let ic;
const A_ = "FunctionToString",
    sc = new WeakMap,
    C_ = () => ({
        name: A_,
        setupOnce() {
...
function I_(r = {}, t = {}) {
    return {
        ...
        ignoreErrors: [...r.ignoreErrors || [], ...t.ignoreErrors || [], ...r.disableErrorDefaults ? [] : U_],
        ignoreTransactions: [...r.ignoreTransactions || [], ...t.ignoreTransactions || []],
        ignoreInternal: r.ignoreInternal !== void 0 ? r.ignoreInternal : !0
    }
}

function D_(r, t) {
    return t.ignoreInternal && q_(r) ? (Le && Re.warn(`Event dropped due to being internal Sentry Error.
Event: ${dt(r)}`),
        !0) : O_(r, t.ignoreErrors) ? (Le && Re.warn(`Event dropped due to being matched by \`ignoreErrors\` option.
Event: ${dt(r)}`),
        !0) : j_(r) ? (Le && Re.warn(`Event dropped due to not having an error message, error type or stacktrace.
Event: ${dt(r)}`),
        !0) : P_(r, t.ignoreTransactions) ? (Le && Re.warn(`Event dropped due to being matched by \`ignoreTransactions\` option.
Event: ${dt(r)}`),
        !0) : k_(r, t.denyUrls) ? (Le && Re.warn(`Event dropped due to being matched by \`denyUrls\` option.
Event: ${dt(r)}.
Url: ${Xr(r)}`),
        !0) : V_(r, t.allowUrls) ? !1 : (Le && Re.warn(`Event dropped due to not being matched by \`allowUrls\` option.
Event: ${dt(r)}.
Url: ${Xr(r)}`),
        !0)
}
...
function O_(r, t) {
    return r.type || !t || !t.length ? !1 : M_(r).some(n => tn(n, t))
}

function P_(r, t) {
    if (r.type !== "transaction" || !t || !t.length)
        return !1;
...
function Xr(r) {
    try {
        ...
        return Le && Re.error(`Cannot extract url for event ${dt(r)}`),
            null
    }
}

function j_(r) {
    return r.type || !r.exception || !r.exception.values || r.exception.values.length === 0 ? !1 : !r.message && !r.exception.values.some(t => t.stacktrace || t.type && t.type !== "Error" || t.value)
}
const X_ = "Dedupe",
    $_ = () => {
        let r;
        return {
            ...
            processEvent(t) {
                ...
                try {
                    if (H_(t, r))
                        return Le && Re.warn("Event dropped due to being a duplicate of previously captured event."),
                            null
                } catch {}
                return r = t
            }
...
function H_(r, t) {
    return t ? !!(W_(r, t) || z_(r, t)) : !1
}

function W_(r, t) {
    const n = r.message,
        i = t.message;
    return !(!n && !i || n && !i || !n && i || n !== i || !v0(r, t) || !d0(r, t))
}

function z_(r, t) {
    const n = ac(t),
        i = ac(r);
    return !(!n || !i || n.type !== i.type || n.value !== i.value || !v0(r, t) || !d0(r, t))
}
...
function d0(r, t) {
    ...
    for (let s = 0; s < i.length; s++) {
        const f = i[s],
            e = n[s];
        if (f.filename !== e.filename || f.lineno !== e.lineno || f.colno !== e.colno || f.function !== e.function)
            return !1
    }
    return !0
}
...
function er(r, t = {}, n) {
    ...
    const i = function() {
        ...
        try {
            ...
            throw J_(),
                Lx(e => {
                    e.addEventProcessor(l => (t.mechanism && (Sa(l, void 0),
                                Rr(l, t.mechanism)),
                            l.extra = {
                                ...l.extra,
                                arguments: s
...
function Y_(r, t, n, i) {
    ...
    if (n) {
        const x = ff(r, n);
        x.length && (p.exception.values[0].stacktrace = {
            frames: x
        })
    }
    return p
...
const Q_ = /Minified React error #\d+;/i;

function Z_(r) {
    return r && Q_.test(r.message) ? 1 : 0
}
...
function tR(r) {
    const t = r && r.name;
    return !t && A0(r) ? r.message && Array.isArray(r.message) && r.message.length == 2 ? r.message[0] : "WebAssembly.Exception" : t
}

function rR(r) {
    const t = r && r.message;
    return t ? t.error && typeof t.error.message == "string" ? t.error.message : A0(r) && Array.isArray(r.message) && r.message.length == 2 ? r.message[1] : t : "No error message"
}
...
function iR(r, t, n = "info", i, s) {
    const f = i && i.syntheticException || void 0,
        e = Ba(r, t, f, s);
    return e.level = n,
        i && i.event_id && (e.event_id = i.event_id),
        kt(e)
}
...
function uf(r, t, n, i, s) {
    ...
    if (Bl(t) || uh(t)) {
        ...
        if ("stack" in t)
            ...
            const l = e.name || (Bl(e) ? "DOMError" : "DOMException"),
                p = e.message ? `${l}: ${e.message}` : l;
            f = Ba(r, p, n, i),
                Sa(f, p)
        }
        return "code" in e && (f.tags = {
                ...f.tags,
                "DOMException.code": `${e.code}`
            }),
            f
    }
    return Ja(t) ? _a(r, t) : Yt(t) || Zr(t) ? (f = Y_(r, t, n, s),
        Rr(f, {
            synthetic: !0
        }),
        f) : (f = Ba(r, t, n, i),
...
function sR(r, {
    ...
    return e0(r) ? `Event \`ErrorEvent\` captured as ${i} with message \`${r.message}\`` : Zr(r) ? `Event \`${aR(r)}\` (type=${r.type}) captured as ${i}` : `Object captured as ${i} with keys: ${n}`
}
...
class lR extends y_ {
    constructor(t) {
        const n = {
            ...
            i = Ae.SENTRY_SDK_SOURCE || Gh();
        v_(n, "browser", ["browser"], i),
            super(n),
            n.sendClientReports && Ae.document && Ae.document.addEventListener("visibilitychange", () => {
                Ae.document.visibilityState === "hidden" && this._flushOutcomes()
            })
    }
    eventFromException(t, n) {
        return nR(this._options.stackParser, t, n, this._options.attachStacktrace)
    }
    eventFromMessage(t, n = "info", i) {
        return iR(this._options.stackParser, t, n, i, this._options.attachStacktrace)
    }
...
function hR() {
    ...
    $e.document.addEventListener("click", t, !1),
        ...
        ["EventTarget", "Node"].forEach(n => {
            ...
            !i || !i.hasOwnProperty || !i.hasOwnProperty("addEventListener") || (Ze(i, "addEventListener", function(s) {
                    return function(f, e, l) {
                        if (f === "click" || f == "keypress")
                            try {
                                const p = this,
                                    x = p.__sentry_instrumentation_handlers__ = p.__sentry_instrumentation_handlers__ || {},
                                    R = x[f] = x[f] || {
                                        refCount: 0
                                    };
                                if (!R.handler) {
                        ...
                        if (f === "click" || f == "keypress")
                            try {
                                const p = this,
                                    ...
                                    R = x[f];
                                R && (R.refCount--,
                                    R.refCount <= 0 && (s.call(this, f, R.handler, l),
                                        R.handler = void 0,
                                        delete x[f]),
                                    Object.keys(x).length === 0 && delete p.__sentry_instrumentation_handlers__)
                            } catch {}
                        return s.call(this, f, e, l)
                    }
                }))
...
function xR(r) {
    if (r.type !== Ua)
        return !1;
    try {
        if (!r.target || r.target._sentryId !== Ka)
            return !1
    } catch {}
    return !0
}
...
function _R(r, t) {
    return r !== "keypress" ? !1 : !t || !t.tagName ? !0 : !(t.tagName === "INPUT" || t.tagName === "TEXTAREA" || t.isContentEditable)
}
...
function uc(r, t = !1) {
    return n => {
        ...
        if (_R(n.type, i))
            return;
        Ot(n, "_sentryCaptured", !0),
            i && !i._sentryId && Ot(i, "_sentryId", it());
...
function yR() {
    ...
    Ze($e.history, "pushState", t),
        Ze($e.history, "replaceState", t)
}
const kr = {};
...
function gR(r) {
    ...
    if (i && typeof i.createElement == "function")
        try {
            ...
            cR && Re.warn(`Could not create sandbox iframe for ${r} check, bailing to window.${r}: `, s)
        }
    ...
    r.open = new Proxy(r.open, {
            apply(t, n, i) {
                ...
                n[_r] = {
                    ...
                    f === "POST" && e.match(/sentry_key/) && (n.__sentry_own_request__ = !0);
                const l = () => {
                    const p = n[_r];
                    if (p && n.readyState === 4) {
                        try {
                ...
                return "onreadystatechange" in n && typeof n.onreadystatechange == "function" ? n.onreadystatechange = new Proxy(n.onreadystatechange, {
                    ...
                    n.setRequestHeader = new Proxy(n.setRequestHeader, {
                        apply(p, x, R) {
                            const [S, v] = R, d = x[_r];
                            return d && ht(S) && ht(v) && (d.request_headers[S.toLowerCase()] = v),
                                p.apply(x, R)
                        }
                    }),
                    t.apply(n, i)
...
const LR = /^\s*at (\S+?)(?::(\d+))(?::(\d+))\s*$/i,
    AR = /^\s*at (?:(.+?\)(?: \[.+\])?|.*?) ?\((?:address at )?)?(?:async )?((?:<anonymous>|[-a-z]+:|.*bundle|\/)?.*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
    CR = /\((\S*)(?::(\d+))(?::(\d+))\)/,
    BR = r => {
        const t = LR.exec(r);
        if (t) {
        ...
        if (n) {
            ...
            const [s, f] = B0(n[1] || Pt, n[2]);
            return wa(f, s, n[3] ? +n[3] : void 0, n[4] ? +n[4] : void 0)
        }
    },
    UR = [dR, BR],
    KR = /^\s*(.*?)(?:\((.*?)\))?(?:^|@)?((?:[-a-z]+)?:\/.*?|\[native code\]|[^@]*(?:bundle|\d+\.js)|\/[\w\-. /=]+)(?::(\d+))?(?::(\d+))?\s*$/i,
    wR = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i,
    NR = r => {
        const t = KR.exec(r);
        if (t) {
    ...
    B0 = (r, t) => {
        ...
        return n || i ? [r.indexOf("@") !== -1 ? r.split("@")[0] : Pt, n ? `safari-extension:${t}` : `safari-web-extension:${t}`] : [r, t]
    },
    Or = 1024,
    PR = "Breadcrumbs",
    kR = (r = {}) => {
        ...
        return {
            ...
            setup(n) {
                t.console && Kh(GR(n)),
                    ...
                    t.fetch && Dh(XR(n)),
                    t.history && C0($R(n)),
                    t.sentry && n.on("beforeSendEvent", MR(n))
            }
        }
    },
    VR = kR;
...
function qR(r, t) {
    return function(i) {
        if (Fe() !== r)
            return;
        let s, f, e = typeof t == "object" ? t.serializeAttribute : void 0,
            l = typeof t == "object" && typeof t.maxStringLength == "number" ? t.maxStringLength : void 0;
        l && l > Or && (Tr && Re.warn(`\`dom.maxStringLength\` cannot exceed ${Or}, but a value of ${l} was configured. Sentry will use ${Or} instead.`),
                l = Or),
            typeof e == "string" && (e = [e]);
        try {
            const x = i.event,
...
function GR(r) {
    return function(n) {
        ...
        if (n.level === "assert")
            if (n.args[0] === !1)
                i.message = `Assertion failed: ${Ul(n.args.slice(1), " ") || "console.assert"}`,
...
const HR = ["EventTarget", "Window", "Node", "ApplicationCache", "AudioTrackList", "BroadcastChannel", "ChannelMergerNode", "CryptoOperation", "EventSource", "FileReader", "HTMLUnknownElement", "IDBDatabase", "IDBRequest", "IDBTransaction", "KeyOperation", "MediaController", "MessagePort", "ModalWindow", "Notification", "SVGElementInstance", "Screen", "SharedWorker", "TextTrack", "TextTrackCue", "TextTrackList", "WebSocket", "WebSocketWorker", "Worker", "XMLHttpRequest", "XMLHttpRequestEventTarget", "XMLHttpRequestUpload"],
    ...
    zR = (r = {}) => {
        ...
        return {
            name: WR,
            setupOnce() {
                t.setTimeout && Ze(Ae, "setTimeout", lc),
                    t.setInterval && Ze(Ae, "setInterval", lc),
                    t.requestAnimationFrame && Ze(Ae, "requestAnimationFrame", YR),
                    t.XMLHttpRequest && "XMLHttpRequest" in Ae && Ze(XMLHttpRequest.prototype, "send", QR);
                const n = t.eventTarget;
                n && (Array.isArray(n) ? n : HR).forEach(ZR)
            }
        }
    },
    JR = zR;
...
function QR(r) {
    return function(...t) {
        ...
        return ["onload", "onerror", "onprogress", "onreadystatechange"].forEach(s => {
                s in n && typeof n[s] == "function" && Ze(n, s, function(f) {
                    const e = {
                            mechanism: {
                                data: {
                                    function: s,
                        ...
                        l = ef(f);
                    return l && (e.mechanism.data.handler = Lt(l)),
                        er(f, e)
                })
            }),
            r.apply(this, t)
...
function ZR(r) {
    const t = Ae,
        n = t[r] && t[r].prototype;
    !n || !n.hasOwnProperty || !n.hasOwnProperty("addEventListener") || (Ze(n, "addEventListener", function(i) {
            return function(s, f, e) {
                try {
                    typeof f.handleEvent == "function" && (f.handleEvent = er(f.handleEvent, {
                        mechanism: {
                            data: {
    ...
    ty = (r = {}) => {
        ...
        return {
            ...
            setup(n) {
                t.onerror && (ny(n),
                        cc("onerror")),
                    t.onunhandledrejection && (iy(n),
                        cc("onunhandledrejection"))
            }
        }
    },
    ry = ty;
...
function ny(r) {
    kh(t => {
        ...
        const {
            ...
            column: l,
            error: p
        } = t, x = fy(uf(n, p || s, void 0, i, !1), f, e, l);
        x.level = "error",
            R0(x, {
                originalException: p,
                mechanism: {
...
const uy = () => ({
        ...
        preprocessEvent(r) {
            if (!Ae.navigator && !Ae.location && !Ae.document)
                return;
            const t = r.request && r.request.url || Ae.location && Ae.location.href,
                {
                    referrer: n
                } = Ae.document || {},
                {
    ...
    py = (r = {}) => {
        ...
        return {
            ...
            preprocessEvent(i, s, f) {
                ...
                Eh(af, e.stackParser, e.maxValueLength, n, t, i, s)
            }
        }
    },
    Ey = py;
...
function hy(r) {
    return [N_(), B_(), JR(), VR(), ry(), Ey(), F_(), uy()]
}
...
function xy(r = {}) {
    ...
    return r.defaultIntegrations == null && delete r.defaultIntegrations, {
        ...t,
        ...r
    }
}
...
function _y() {
    ...
    const t = r.chrome ? "chrome" : "browser",
        ...
        f = ["chrome-extension:", "moz-extension:", "ms-browser-extension:", "safari-web-extension:"],
...
function Ry(r = {}) {
    const t = xy(r);
    if (!t.skipBrowserExtensionCheck && _y()) {
        gr(() => {
            console.error("[Sentry] You cannot run Sentry this way in a browser extension, check: https://docs.sentry.io/platforms/javascript/best-practices/browser-extensions/")
        });
        return
    }
    Tr && (o0() || Re.warn("No Fetch API detected. The Sentry SDK requires a Fetch API compatible environment to send events. Please add a Fetch API polyfill."));
    const n = {
            ...t,
            stackParser: Bh(t.stackParser || OR),
            integrations: __(t),
            transport: t.transport || SR
        },
        i = m_(lR, n);
    return t.autoSessionTracking && yy(),
        i
}

function yy() {
    if (typeof Ae.document > "u") {
        Tr && Re.warn("Session tracking in non-browser environment with @sentry/browser is not supported.");
        return
    }
    Ql({
            ignoreDuration: !0
...
const gy = "UNABLE TO LOAD. TAP TO TRY AGAIN.",
    by = {
        RETRY: gy
    },
    my = "CHARGEMENT IMPOSSIBLE. APPUYEZ POUR RÉESSAYER.",
    Ty = {
        RETRY: my
    },
    Sy = "IMPOSSIBILE CARICARE. CLICCA PER RIPROVARE.",
    dy = {
        RETRY: Sy
    },
    vy = "LADEN FEHLGESCHLAGEN. DRÜCKEN ZUM ERNEUT VERSUCHEN.",
    Ly = {
        RETRY: vy
    },
    Ay = "CARGA FALLIDA. TOCA PARA VOLVER A INTENTARLO.",
    Cy = {
        RETRY: Ay
    },
    By = "NO SE PUEDE CARGAR. TOCA PARA VOLVER A INTENTARLO.",
    Uy = {
        RETRY: By
    },
    Ky = "NÃO FOI POSSÍVEL CARREGAR. TOQUE PARA TENTAR DE NOVO.",
    wy = {
        RETRY: Ky
    },
    pc = {
...
let Ny = class {
    constructor(t) {
        ...
        ze(this, "load", async t => {
            ...
            if (!f)
                throw new Error(`[loader] Unknown app "${t.app}" can not be loaded from branch "${i}"`);
            try {
                i === "** hmr **" ? await this.loadHMRBundle(f) : i === "** dist **" ? await this.loadDistBundle(f) : await this.loadS3Bundle(f)
            } catch (l) {
                console.error(`[loader] Unable to load "${t.app}" from branch "${i}":`, l),
                    this.showLoaderError();
                return
            }
            if (WE("[loader] load success", {
                    app: t.app,
        ...
        ze(this, "mount", t => {
            ...
            Vr.setup(t.app, ((l = t.room) == null ? void 0 : l.code) ?? ((p = t.client) == null ? void 0 : p.code));
            const i = document.querySelectorAll("[data-tv-style]"),
                f = Array.from(document.querySelectorAll("[data-tv-prefetch]")).map(x => {
    ...
    getBranchName(t) {
        var f, e, l, p, x;
        const n = (e = (f = t.match) == null ? void 0 : f.params) == null ? void 0 : e.branch,
            i = Vr.get("preference:branch"),
            s = this.manifest.branches;
        if (n)
            return n === "hmr" ? "** hmr **" : n === "dist" ? "** dist **" : n;
        if (t.branch)
            return t.branch;
        if ((l = s["** hmr **"]) != null && l.bundles[t.app])
            return "** hmr **";
        if (i && ((p = s[i]) != null && p.bundles[t.app]))
            return i;
        if ((x = s["** dist **"]) != null && x.bundles[t.app])
            return "** dist **";
        if (s.main)
            return "main";
    ...
    async fetchBundle(t, n, i, w = "") {
        n.forEach(f => {
            const e = i ? this.getS3Url(f + w, i) : f + w,
                l = document.createElement("link");
            i ? l.rel = "prefetch" : (l.rel = "preload",
                    l.as = "style"),
                l.href = e,
                l.setAttribute("data-tv-prefetch", ""),
                document.head.append(l)
        });
        const s = i ? this.getS3Url(t + w, i) : t + w;
    ...
    async loadS3Bundle(t) {
        return this.fetchBundle(t.file, t.css, t.base, "?v=" + t.version)
    }
    showLoaderError() {
...
const Ec = {
    ...
    Iy = ["ceCurrentVideo.currentTime", "chrome-extension", "ResizeObserver", "webkitExitFullScreen", "window.webkit.messageHandlers.selectedTextHandler.postMessage", "promiseResolveThenableJob", "Cannot read property 'then' of undefined", "null is not an object (evaluating 't.scrollHeight')", "Cannot read properties of null (reading 'removeEventListener')"],
    Dy = r => {
        Ry({
                ...
                beforeSend: async (t, n) => {
                    if (n.originalException) {
                        ...
                        if (i.code === Ec.EcastEntityNotFound)
                            return o_("no entity found having key", {
                                    extra: {
                                        exception: n.originalException
                                    }
                                }),
                                null;
                        if (i.code === Ec.EcastFilterError)
                            return null
                    }
                    if (window.tv.onError)
                        try {
                            const i = await window.tv.onError(t, n);
                            i && (t.contexts = t.contexts || {},
                                t.contexts.debug = i)
                        } catch (i) {
...
async function xc() {
    if (!hc)
        try {
            hc = await navigator.wakeLock.request("screen")
        } catch (r) {
            console.warn(r)
        }
}
const Oy = async () => {
    navigator.wakeLock && (await xc(),
        document.addEventListener("visibilitychange", () => {
            document.visibilityState === "visible" && xc()
        }))
};

function Py(r) {
    let t = "<div>";
    return r ? (t += `   <h1>Debug JSON Index : ${r}</h1>`,
            Object.keys(window.tv.debugMap[r]).forEach(n => {
                t += `    <a href="/${window.tv.debugMap[r][n]}" target="_blank">${n}</a>`
            })) : (t += "   <h1>Debug JSON Index</h1>",
            Object.keys(window.tv.debugMap).sort().forEach(n => {
                t += "    <details>",
                    t += `        <summary>${n}</summary>`,
...
function Vy() {
    ...
    return t += "   <h2>Loader</h2>",
        ...
        t += "   <h2>Branches</h2>",
        Object.keys(r.branches).sort().forEach(i => {
            ...
            t += "    <details>",
                ...
                t += `            <span class="type">${Object.keys(s.bundles).length} Apps</span>`,
                t += "        </summary>",
                Object.keys(s.bundles).forEach(e => {
                    const l = s.bundles[e];
                    l.version ? t += `        <p><span class="name">${e}</span> <span class="version">${l.version}</span></p>` : t += `        <p><span class="name">${e}</span> <span class="version">${s.version}</span></p>`
                }),
                t += "    </details>"
        }),
        t += "</div>",
...
function qy() {
    ...
    r.innerHTML = My(),
        document.getElementsByTagName("html")[0].append(r);
...
const Gy = {
        routes: [{
            ...
            handler: r => ({
                redirect: `/past-games/${r.data.galleryId}`
            })
        }, {
            path: ["/gallery/:galleryId/:artifactId", "/gallery/:galleryId/:artifactId/:itemId"],
            handler: r => {
                const t = pf(r.data.galleryId);
                return !t || !t.categoryId ? {
                    redirect: "/"
                } : (r.data.categoryId = t.categoryId, {
                    load: t.tag
                })
            }
        }, {
            path: ["/render/incoming/:gameId/:renderer", "/render/payload/:gameId/:renderer", "/render/artifact/:gameId/:artifactId/:renderer", "/render/:gameId/:artifactId/:renderer"],
            handler: r => {
                const t = pf(r.data.gameId);
                return t ? {
                    load: t.tag
                } : {
                    redirect: "/"
...
class Xy {
    ...
    executeMatch(t) {
        var i, s;
        const n = ((s = t == null ? void 0 : (i = t.route).handler) == null ? void 0 : s.call(i, t)) ?? (t == null ? void 0 : t.route);
        if (!t || !n) {
            this.redirect("/", t);
            return
        }
    ...
    redirect(t, n) {
        ...
        n && (i.hashString || (i.hashString = n.hashString),
    ...
    getSite() {
        ...
        return (t === "localhost" || t === "127.0.0.1" ? this.sites.find(i => {
            var s;
...
const $y = "production",
    ...
    Hy = {
        branch: "main",
        sha: "0a2f65b508a98aceb8bf566171ddf09a53ec6b3b",
        lastUpdated: 1762637920484,
        version: "5.1252.656",
        type: "production"
    },
    Wy = {
...
Oy();
new Xy([Gy, jy]);
//# sourceMappingURL=DuBA4eOp.js.map
